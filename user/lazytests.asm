...
sparse_memory(char *s)
{
  ...
  50:	a9c50513          	addi	a0,a0,-1380 # ae8 <malloc+0x11a>
  ...
  6a:	a9250513          	addi	a0,a0,-1390 # af8 <malloc+0x12a>
...
sparse_memory_unmap(char *s)
{
  ...
  f0:	9fc50513          	addi	a0,a0,-1540 # ae8 <malloc+0x11a>
 ...
 10a:	a1a50513          	addi	a0,a0,-1510 # b20 <malloc+0x152>
 ...
 128:	4ec080e7          	jalr	1260(ra) # 610 <sbrk>
      *(char **)i = i;
 12c:	01293023          	sd	s2,0(s2) # 1000 <__BSS_END__+0x3a0>
      exit(0);
 130:	4501                	li	a0,0
 ...
 13e:	9f650513          	addi	a0,a0,-1546 # b30 <malloc+0x162>
...
run(void f(char *), char *s) {
 ...
 1b4:	99850513          	addi	a0,a0,-1640 # b48 <malloc+0x17a>
 ...
 20a:	95a50513          	addi	a0,a0,-1702 # b60 <malloc+0x192>
 ...
 234:	96050513          	addi	a0,a0,-1696 # b90 <malloc+0x1c2>
...
main(int argc, char *argv[])
{
 ...
 262:	98a78793          	addi	a5,a5,-1654 # be8 <malloc+0x21a>
 ...
 29e:	90650513          	addi	a0,a0,-1786 # ba0 <malloc+0x1d2>
 ...
 2ea:	8ea50513          	addi	a0,a0,-1814 # bd0 <malloc+0x202>
 2ee:	00000097          	auipc	ra,0x0
 2f2:	622080e7          	jalr	1570(ra) # 910 <printf>
 2f6:	a809                	j	308 <main+0xc6>
    printf("ALL TESTS PASSED\n");
 2f8:	00001517          	auipc	a0,0x1
 2fc:	8c050513          	addi	a0,a0,-1856 # bb8 <malloc+0x1ea>
...
gets(char *buf, int max)
{
 ...
 426:	00098023          	sb	zero,0(s3) # 1000000 <__global_pointer$+0xffebbf>
  return buf;
}
 42a:	855e                	mv	a0,s7
...
atoi(const char *s)
{
 ...
 4b4:	fd07851b          	addiw	a0,a5,-48
  while('0' <= *s && *s <= '9')
 4b8:	0006c603          	lbu	a2,0(a3) # 40000 <__global_pointer$+0x3ebbf>
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 4f6:	fed70fa3          	sb	a3,-1(a4) # ffffff <__global_pointer$+0xffebbe>
    while(n-- > 0)
...
putc(int fd, char c)
{
 ...
 64e:	f5e080e7          	jalr	-162(ra) # 5a8 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 680:	5b450513          	addi	a0,a0,1460 # c30 <digits>
 684:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 74c:	4e8b8b93          	addi	s7,s7,1256 # c30 <digits>
 ...
 766:	fff4c903          	lbu	s2,-1(s1) # 40000fff <__global_pointer$+0x3ffffbbe>
 ...
 88c:	3a090913          	addi	s2,s2,928 # c28 <malloc+0x25a>
        while(*s != 0){
...
free(void *ap)
{
 ...
 954:	2f87b783          	ld	a5,760(a5) # c48 <freep>
 ...
 982:	00e6ea63          	bltu	a3,a4,996 <free+0x50>
{
 ...
 9c4:	28f73423          	sd	a5,648(a4) # c48 <freep>
}
 9c8:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 9f6:	25653503          	ld	a0,598(a0) # c48 <freep>
 ...
 a1e:	22e90913          	addi	s2,s2,558 # c48 <freep>
  if(p == (char*)-1)
 a22:	5afd                	li	s5,-1
 a24:	a88d                	j	a96 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 a26:	00000797          	auipc	a5,0x0
 a2a:	22a78793          	addi	a5,a5,554 # c50 <base>
 a2e:	00000717          	auipc	a4,0x0
 a32:	20f73d23          	sd	a5,538(a4) # c48 <freep>
 a36:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a58:	1ea73a23          	sd	a0,500(a4) # c48 <freep>
      return (void*)(p + 1);
 ...
 aa6:	b6e080e7          	jalr	-1170(ra) # 610 <sbrk>
  if(p == (char*)-1)
