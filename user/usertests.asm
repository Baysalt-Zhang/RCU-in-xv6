...
createtest(char *s)
{
  ...
  name[0] = 'a';
      ...
      12:	ffa78793          	addi	a5,a5,-6 # 7008 <name>
  ...
  name[0] = 'a';
      ...
      54:	fb878793          	addi	a5,a5,-72 # 7008 <name>
...
0000000000000094 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
      ...
      d4:	fc858593          	addi	a1,a1,-56 # 5098 <malloc+0x39a>
  ...
  int fd2 = open("truncfile", O_RDONLY);
      ...
      f0:	f9c50513          	addi	a0,a0,-100 # 5088 <malloc+0x38a>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     11c:	f7050513          	addi	a0,a0,-144 # 5088 <malloc+0x38a>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     130:	f5c50513          	addi	a0,a0,-164 # 5088 <malloc+0x38a>
  ...
  write(fd1, "abcdef", 6);
     ...
     16e:	f9658593          	addi	a1,a1,-106 # 5100 <malloc+0x402>
     172:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     1b0:	edc50513          	addi	a0,a0,-292 # 5088 <malloc+0x38a>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     1f4:	eb050513          	addi	a0,a0,-336 # 50a0 <malloc+0x3a2>
     1f8:	00005097          	auipc	ra,0x5
     1fc:	a48080e7          	jalr	-1464(ra) # 4c40 <printf>
    exit(1);
     200:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     210:	eb450513          	addi	a0,a0,-332 # 50c0 <malloc+0x3c2>
     214:	00005097          	auipc	ra,0x5
     218:	a2c080e7          	jalr	-1492(ra) # 4c40 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     21c:	8652                	mv	a2,s4
     21e:	85d6                	mv	a1,s5
     220:	00005517          	auipc	a0,0x5
     224:	eb050513          	addi	a0,a0,-336 # 50d0 <malloc+0x3d2>
     228:	00005097          	auipc	ra,0x5
     22c:	a18080e7          	jalr	-1512(ra) # 4c40 <printf>
    exit(1);
     230:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     240:	eb450513          	addi	a0,a0,-332 # 50f0 <malloc+0x3f2>
     244:	00005097          	auipc	ra,0x5
     248:	9fc080e7          	jalr	-1540(ra) # 4c40 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     24c:	8652                	mv	a2,s4
     24e:	85d6                	mv	a1,s5
     250:	00005517          	auipc	a0,0x5
     254:	e8050513          	addi	a0,a0,-384 # 50d0 <malloc+0x3d2>
     258:	00005097          	auipc	ra,0x5
     25c:	9e8080e7          	jalr	-1560(ra) # 4c40 <printf>
    exit(1);
     260:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     272:	e9a50513          	addi	a0,a0,-358 # 5108 <malloc+0x40a>
     276:	00005097          	auipc	ra,0x5
     27a:	9ca080e7          	jalr	-1590(ra) # 4c40 <printf>
    exit(1);
     27e:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     290:	e9c50513          	addi	a0,a0,-356 # 5128 <malloc+0x42a>
     294:	00005097          	auipc	ra,0x5
     298:	9ac080e7          	jalr	-1620(ra) # 4c40 <printf>
    exit(1);
     29c:	4505                	li	a0,1
...
00000000000002a6 <truncate2>:
{
  ...
  int n = write(fd1, "x", 1);
     ...
     30a:	e4258593          	addi	a1,a1,-446 # 5148 <malloc+0x44a>
     30e:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     322:	d6a50513          	addi	a0,a0,-662 # 5088 <malloc+0x38a>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     358:	dfc50513          	addi	a0,a0,-516 # 5150 <malloc+0x452>
     35c:	00005097          	auipc	ra,0x5
     360:	8e4080e7          	jalr	-1820(ra) # 4c40 <printf>
    exit(1);
     364:	4505                	li	a0,1
...
000000000000036e <opentest>:
{
  ...
  fd = open("echo", 0);
     ...
     380:	dfc50513          	addi	a0,a0,-516 # 5178 <malloc+0x47a>
  ...
  fd = open("doesnotexist", 0);
     ...
     39e:	dfe50513          	addi	a0,a0,-514 # 5198 <malloc+0x49a>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
     ...
     3be:	dc650513          	addi	a0,a0,-570 # 5180 <malloc+0x482>
     3c2:	00005097          	auipc	ra,0x5
     3c6:	87e080e7          	jalr	-1922(ra) # 4c40 <printf>
    exit(1);
     3ca:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     3da:	dd250513          	addi	a0,a0,-558 # 51a8 <malloc+0x4aa>
     3de:	00005097          	auipc	ra,0x5
     3e2:	862080e7          	jalr	-1950(ra) # 4c40 <printf>
    exit(1);
     3e6:	4505                	li	a0,1
...
00000000000003f0 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     40e:	dc650513          	addi	a0,a0,-570 # 51d0 <malloc+0x4d2>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     426:	dd698993          	addi	s3,s3,-554 # 51f8 <malloc+0x4fa>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     42a:	00005a97          	auipc	s5,0x5
     42e:	e06a8a93          	addi	s5,s5,-506 # 5230 <malloc+0x532>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     474:	d6050513          	addi	a0,a0,-672 # 51d0 <malloc+0x4d2>
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     48e:	39e58593          	addi	a1,a1,926 # 9828 <buf>
  ...
  if(unlink("small") < 0){
     ...
     4b0:	d2450513          	addi	a0,a0,-732 # 51d0 <malloc+0x4d2>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     4da:	d0250513          	addi	a0,a0,-766 # 51d8 <malloc+0x4da>
     4de:	00004097          	auipc	ra,0x4
     4e2:	762080e7          	jalr	1890(ra) # 4c40 <printf>
    exit(1);
     4e6:	4505                	li	a0,1
     ...
     4f6:	d1650513          	addi	a0,a0,-746 # 5208 <malloc+0x50a>
     4fa:	00004097          	auipc	ra,0x4
     4fe:	746080e7          	jalr	1862(ra) # 4c40 <printf>
      exit(1);
     502:	4505                	li	a0,1
     ...
     512:	d3250513          	addi	a0,a0,-718 # 5240 <malloc+0x542>
     516:	00004097          	auipc	ra,0x4
     51a:	72a080e7          	jalr	1834(ra) # 4c40 <printf>
      exit(1);
     51e:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     52e:	d3e50513          	addi	a0,a0,-706 # 5268 <malloc+0x56a>
     532:	00004097          	auipc	ra,0x4
     536:	70e080e7          	jalr	1806(ra) # 4c40 <printf>
    exit(1);
     53a:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     54a:	d4250513          	addi	a0,a0,-702 # 5288 <malloc+0x58a>
     54e:	00004097          	auipc	ra,0x4
     552:	6f2080e7          	jalr	1778(ra) # 4c40 <printf>
    exit(1);
     556:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     566:	d3e50513          	addi	a0,a0,-706 # 52a0 <malloc+0x5a2>
     56a:	00004097          	auipc	ra,0x4
     56e:	6d6080e7          	jalr	1750(ra) # 4c40 <printf>
    exit(1);
     572:	4505                	li	a0,1
...
000000000000057c <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     598:	d2c50513          	addi	a0,a0,-724 # 52c0 <malloc+0x5c2>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     5ac:	28090913          	addi	s2,s2,640 # 9828 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
     ...
     5ea:	cda50513          	addi	a0,a0,-806 # 52c0 <malloc+0x5c2>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     5fe:	22e90913          	addi	s2,s2,558 # 9828 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     632:	c9a50513          	addi	a0,a0,-870 # 52c8 <malloc+0x5ca>
     636:	00004097          	auipc	ra,0x4
     63a:	60a080e7          	jalr	1546(ra) # 4c40 <printf>
    exit(1);
     63e:	4505                	li	a0,1
     ...
     64e:	c9e50513          	addi	a0,a0,-866 # 52e8 <malloc+0x5ea>
     652:	00004097          	auipc	ra,0x4
     656:	5ee080e7          	jalr	1518(ra) # 4c40 <printf>
      exit(1);
     65a:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     66a:	caa50513          	addi	a0,a0,-854 # 5310 <malloc+0x612>
     66e:	00004097          	auipc	ra,0x4
     672:	5d2080e7          	jalr	1490(ra) # 4c40 <printf>
    exit(1);
     676:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     696:	c2e50513          	addi	a0,a0,-978 # 52c0 <malloc+0x5c2>
     ...
     6c0:	c7450513          	addi	a0,a0,-908 # 5330 <malloc+0x632>
     6c4:	00004097          	auipc	ra,0x4
     6c8:	57c080e7          	jalr	1404(ra) # 4c40 <printf>
        exit(1);
     6cc:	4505                	li	a0,1
     ...
     6dc:	c8050513          	addi	a0,a0,-896 # 5358 <malloc+0x65a>
     6e0:	00004097          	auipc	ra,0x4
     6e4:	560080e7          	jalr	1376(ra) # 4c40 <printf>
      exit(1);
     6e8:	4505                	li	a0,1
     ...
     6f8:	c7c50513          	addi	a0,a0,-900 # 5370 <malloc+0x672>
     6fc:	00004097          	auipc	ra,0x4
     700:	544080e7          	jalr	1348(ra) # 4c40 <printf>
      exit(1);
     704:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     714:	c8850513          	addi	a0,a0,-888 # 5398 <malloc+0x69a>
     718:	00004097          	auipc	ra,0x4
     71c:	528080e7          	jalr	1320(ra) # 4c40 <printf>
    exit(1);
     720:	4505                	li	a0,1
...
unlinkread(char *s)
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     742:	7aa50513          	addi	a0,a0,1962 # 4ee8 <malloc+0x1ea>
  ...
  write(fd, "hello", SZ);
     ...
     75a:	c7a58593          	addi	a1,a1,-902 # 53d0 <malloc+0x6d2>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     776:	77650513          	addi	a0,a0,1910 # 4ee8 <malloc+0x1ea>
  ...
  if(unlink("unlinkread") != 0){
     ...
     78c:	76050513          	addi	a0,a0,1888 # 4ee8 <malloc+0x1ea>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     7a2:	74a50513          	addi	a0,a0,1866 # 4ee8 <malloc+0x1ea>
  ...
  write(fd1, "yyy", 3);
     ...
     7b6:	c6658593          	addi	a1,a1,-922 # 5418 <malloc+0x71a>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     7d2:	05a58593          	addi	a1,a1,90 # 9828 <buf>
     7d6:	8526                	mv	a0,s1
  ...
  if(buf[0] != 'h'){
     ...
     7ea:	04274703          	lbu	a4,66(a4) # 9828 <buf>
  ...
  if(write(fd, buf, 10) != 10){
     ...
     7fc:	03058593          	addi	a1,a1,48 # 9828 <buf>
     800:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     81e:	6ce50513          	addi	a0,a0,1742 # 4ee8 <malloc+0x1ea>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     83e:	b7650513          	addi	a0,a0,-1162 # 53b0 <malloc+0x6b2>
     842:	00004097          	auipc	ra,0x4
     846:	3fe080e7          	jalr	1022(ra) # 4c40 <printf>
    exit(1);
     84a:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     85a:	b8250513          	addi	a0,a0,-1150 # 53d8 <malloc+0x6da>
     85e:	00004097          	auipc	ra,0x4
     862:	3e2080e7          	jalr	994(ra) # 4c40 <printf>
    exit(1);
     866:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     876:	b8650513          	addi	a0,a0,-1146 # 53f8 <malloc+0x6fa>
     87a:	00004097          	auipc	ra,0x4
     87e:	3c6080e7          	jalr	966(ra) # 4c40 <printf>
    exit(1);
     882:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     892:	b9250513          	addi	a0,a0,-1134 # 5420 <malloc+0x722>
     896:	00004097          	auipc	ra,0x4
     89a:	3aa080e7          	jalr	938(ra) # 4c40 <printf>
    exit(1);
     89e:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     8ae:	b9650513          	addi	a0,a0,-1130 # 5440 <malloc+0x742>
     8b2:	00004097          	auipc	ra,0x4
     8b6:	38e080e7          	jalr	910(ra) # 4c40 <printf>
    exit(1);
     8ba:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     8ca:	b9a50513          	addi	a0,a0,-1126 # 5460 <malloc+0x762>
     8ce:	00004097          	auipc	ra,0x4
     8d2:	372080e7          	jalr	882(ra) # 4c40 <printf>
    exit(1);
     8d6:	4505                	li	a0,1
...
bigwrite(char *s)
{
  ...
  unlink("bigwrite");
     ...
     8fc:	65850513          	addi	a0,a0,1624 # 4f50 <malloc+0x252>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     910:	644a8a93          	addi	s5,s5,1604 # 4f50 <malloc+0x252>
    ...
    for(i = 0; i < 2; i++){
     ...
     918:	f14a0a13          	addi	s4,s4,-236 # 9828 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     91c:	6b0d                	lui	s6,0x3
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     992:	af250513          	addi	a0,a0,-1294 # 5480 <malloc+0x782>
     996:	00004097          	auipc	ra,0x4
     99a:	2aa080e7          	jalr	682(ra) # 4c40 <printf>
      exit(1);
     99e:	4505                	li	a0,1
     ...
     9b6:	aee50513          	addi	a0,a0,-1298 # 54a0 <malloc+0x7a2>
     9ba:	00004097          	auipc	ra,0x4
     9be:	286080e7          	jalr	646(ra) # 4c40 <printf>
        exit(1);
     9c2:	4505                	li	a0,1
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
     ...
     9d0:	74c78793          	addi	a5,a5,1868 # 7118 <uninit>
     9d4:	00009697          	auipc	a3,0x9
     9d8:	e5468693          	addi	a3,a3,-428 # 9828 <buf>
    if(uninit[i] != '\0'){
     ...
     9e8:	8082                	ret
{
     ...
     9f8:	ac450513          	addi	a0,a0,-1340 # 54b8 <malloc+0x7ba>
     9fc:	00004097          	auipc	ra,0x4
     a00:	244080e7          	jalr	580(ra) # 4c40 <printf>
      exit(1);
     a04:	4505                	li	a0,1
...
0000000000000a0e <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
     ...
     a2a:	66250513          	addi	a0,a0,1634 # 5088 <malloc+0x38a>
  ...
  if(pid == 0){
     ...
     a54:	638a0a13          	addi	s4,s4,1592 # 5088 <malloc+0x38a>
      int n = write(fd, "1234567890", 10);
     a58:	00005a97          	auipc	s5,0x5
     a5c:	aa8a8a93          	addi	s5,s5,-1368 # 5500 <malloc+0x802>
      int fd = open("truncfile", O_WRONLY);
     a60:	4585                	li	a1,1
     a62:	8552                	mv	a0,s4
    ...
    printf("%s: fork failed\n", s);
     ...
     acc:	a0850513          	addi	a0,a0,-1528 # 54d0 <malloc+0x7d2>
     ad0:	00004097          	auipc	ra,0x4
     ad4:	170080e7          	jalr	368(ra) # 4c40 <printf>
    exit(1);
     ad8:	4505                	li	a0,1
     ...
     ae8:	a0450513          	addi	a0,a0,-1532 # 54e8 <malloc+0x7ea>
     aec:	00004097          	auipc	ra,0x4
     af0:	154080e7          	jalr	340(ra) # 4c40 <printf>
        exit(1);
     af4:	4505                	li	a0,1
     ...
     b06:	a0e50513          	addi	a0,a0,-1522 # 5510 <malloc+0x812>
     b0a:	00004097          	auipc	ra,0x4
     b0e:	136080e7          	jalr	310(ra) # 4c40 <printf>
        exit(1);
     b12:	4505                	li	a0,1
    ...
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
     ...
     b24:	568a0a13          	addi	s4,s4,1384 # 5088 <malloc+0x38a>
    int n = write(fd, "xxx", 3);
     b28:	00005a97          	auipc	s5,0x5
     b2c:	a08a8a93          	addi	s5,s5,-1528 # 5530 <malloc+0x832>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
     ...
     b76:	51650513          	addi	a0,a0,1302 # 5088 <malloc+0x38a>
  ...
  exit(xstatus);
     ...
     b94:	95850513          	addi	a0,a0,-1704 # 54e8 <malloc+0x7ea>
     b98:	00004097          	auipc	ra,0x4
     b9c:	0a8080e7          	jalr	168(ra) # 4c40 <printf>
      exit(1);
     ba0:	4505                	li	a0,1
     ...
     bb2:	98a50513          	addi	a0,a0,-1654 # 5538 <malloc+0x83a>
     bb6:	00004097          	auipc	ra,0x4
     bba:	08a080e7          	jalr	138(ra) # 4c40 <printf>
      exit(1);
     bbe:	4505                	li	a0,1
...
0000000000000bc8 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
     ...
     c24:	8b050513          	addi	a0,a0,-1872 # 54d0 <malloc+0x7d2>
     c28:	00004097          	auipc	ra,0x4
     c2c:	018080e7          	jalr	24(ra) # 4c40 <printf>
      exit(1);
     c30:	4505                	li	a0,1
     ...
     c40:	91c50513          	addi	a0,a0,-1764 # 5558 <malloc+0x85a>
     c44:	00004097          	auipc	ra,0x4
     c48:	ffc080e7          	jalr	-4(ra) # 4c40 <printf>
        exit(1);
     c4c:	4505                	li	a0,1
     ...
     c5c:	91850513          	addi	a0,a0,-1768 # 5570 <malloc+0x872>
     c60:	00004097          	auipc	ra,0x4
     c64:	fe0080e7          	jalr	-32(ra) # 4c40 <printf>
        exit(1);
     c68:	4505                	li	a0,1
...
0000000000000c7c <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
     ...
     cd4:	80050513          	addi	a0,a0,-2048 # 54d0 <malloc+0x7d2>
     cd8:	00004097          	auipc	ra,0x4
     cdc:	f68080e7          	jalr	-152(ra) # 4c40 <printf>
      exit(1);
     ce0:	4505                	li	a0,1
     ...
     cf8:	7dc50513          	addi	a0,a0,2012 # 54d0 <malloc+0x7d2>
     cfc:	00004097          	auipc	ra,0x4
     d00:	f44080e7          	jalr	-188(ra) # 4c40 <printf>
        exit(1);
     d04:	4505                	li	a0,1
...
0000000000000d16 <forkfork>:
{
    ...
    if(xstatus != 0) {
     ...
     d72:	82250513          	addi	a0,a0,-2014 # 5590 <malloc+0x892>
     d76:	00004097          	auipc	ra,0x4
     d7a:	eca080e7          	jalr	-310(ra) # 4c40 <printf>
      exit(1);
     d7e:	4505                	li	a0,1
     ...
     d84:	b38080e7          	jalr	-1224(ra) # 48b8 <exit>
{
     ...
     dca:	7da50513          	addi	a0,a0,2010 # 55a0 <malloc+0x8a2>
     dce:	00004097          	auipc	ra,0x4
     dd2:	e72080e7          	jalr	-398(ra) # 4c40 <printf>
      exit(1);
     dd6:	4505                	li	a0,1
...
0000000000000de0 <reparent2>:
{
  ...
  exit(0);
     ...
     e18:	e4c50513          	addi	a0,a0,-436 # 5c60 <malloc+0xf62>
     e1c:	00004097          	auipc	ra,0x4
     e20:	e24080e7          	jalr	-476(ra) # 4c40 <printf>
      exit(1);
     e24:	4505                	li	a0,1
...
0000000000000e48 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    for(pi = 0; pi < NCHILD; pi++){
     ...
     eb6:	dae50513          	addi	a0,a0,-594 # 5c60 <malloc+0xf62>
     eba:	00004097          	auipc	ra,0x4
     ebe:	d86080e7          	jalr	-634(ra) # 4c40 <printf>
      exit(1);
     ec2:	4505                	li	a0,1
     ...
     ee2:	6e250513          	addi	a0,a0,1762 # 55c0 <malloc+0x8c2>
     ee6:	00004097          	auipc	ra,0x4
     eea:	d5a080e7          	jalr	-678(ra) # 4c40 <printf>
          exit(1);
     eee:	4505                	li	a0,1
     ...
     f54:	68850513          	addi	a0,a0,1672 # 55d8 <malloc+0x8da>
     f58:	00004097          	auipc	ra,0x4
     f5c:	ce8080e7          	jalr	-792(ra) # 4c40 <printf>
            exit(1);
     f60:	4505                	li	a0,1
     ...
     f88:	66c50513          	addi	a0,a0,1644 # 55f0 <malloc+0x8f2>
     f8c:	00004097          	auipc	ra,0x4
     f90:	cb4080e7          	jalr	-844(ra) # 4c40 <printf>
        exit(1);
     f94:	4505                	li	a0,1
    ...
    for(pi = 0; pi < NCHILD; pi++){
     ...
     fee:	62e50513          	addi	a0,a0,1582 # 5618 <malloc+0x91a>
     ff2:	00004097          	auipc	ra,0x4
     ff6:	c4e080e7          	jalr	-946(ra) # 4c40 <printf>
        exit(1);
     ffa:	4505                	li	a0,1
...
000000000000106e <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    109e:	5be50513          	addi	a0,a0,1470 # 5658 <malloc+0x95a>
    10a2:	00004097          	auipc	ra,0x4
    10a6:	b9e080e7          	jalr	-1122(ra) # 4c40 <printf>
    exit(1);
    10aa:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    1100:	54450513          	addi	a0,a0,1348 # 5640 <malloc+0x942>
    1104:	00004097          	auipc	ra,0x4
    1108:	b3c080e7          	jalr	-1220(ra) # 4c40 <printf>
    exit(1);
    110c:	4505                	li	a0,1
    ...
    111c:	56850513          	addi	a0,a0,1384 # 5680 <malloc+0x982>
    1120:	00004097          	auipc	ra,0x4
    1124:	b20080e7          	jalr	-1248(ra) # 4c40 <printf>
      exit(1);
    1128:	4505                	li	a0,1
    ...
    1138:	56450513          	addi	a0,a0,1380 # 5698 <malloc+0x99a>
    113c:	00004097          	auipc	ra,0x4
    1140:	b04080e7          	jalr	-1276(ra) # 4c40 <printf>
    exit(1);
    1144:	4505                	li	a0,1
...
000000000000114e <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    116a:	35098993          	addi	s3,s3,848 # c350 <buf+0x2b28>
    116e:	1003d937          	lui	s2,0x1003d
    1172:	090e                	slli	s2,s2,0x3
    1174:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x10030c48>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    11b8:	31c50513          	addi	a0,a0,796 # 54d0 <malloc+0x7d2>
    11bc:	00004097          	auipc	ra,0x4
    11c0:	a84080e7          	jalr	-1404(ra) # 4c40 <printf>
      exit(1);
    11c4:	4505                	li	a0,1
    ...
    11d8:	4dc50513          	addi	a0,a0,1244 # 56b0 <malloc+0x9b2>
    11dc:	00004097          	auipc	ra,0x4
    11e0:	a64080e7          	jalr	-1436(ra) # 4c40 <printf>
      exit(1);
    11e4:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    1236:	0007c583          	lbu	a1,0(a5) # fffffffffffff000 <__BSS_END__+0xffffffffffff27c8>
    123a:	00004517          	auipc	a0,0x4
    123e:	49650513          	addi	a0,a0,1174 # 56d0 <malloc+0x9d2>
    1242:	00004097          	auipc	ra,0x4
    1246:	9fe080e7          	jalr	-1538(ra) # 4c40 <printf>
    exit(1);
    124a:	4505                	li	a0,1
    ...
    125a:	27a50513          	addi	a0,a0,634 # 54d0 <malloc+0x7d2>
    125e:	00004097          	auipc	ra,0x4
    1262:	9e2080e7          	jalr	-1566(ra) # 4c40 <printf>
    exit(1);
    1266:	4505                	li	a0,1
...
000000000000127a <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    128a:	64250513          	addi	a0,a0,1602 # 58c8 <malloc+0xbca>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    129c:	48850513          	addi	a0,a0,1160 # 5720 <malloc+0xa22>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    12b2:	4ca50513          	addi	a0,a0,1226 # 5778 <malloc+0xa7a>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    12d0:	52450513          	addi	a0,a0,1316 # 57f0 <malloc+0xaf2>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    12ec:	57850513          	addi	a0,a0,1400 # 5860 <malloc+0xb62>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    12fe:	5be50513          	addi	a0,a0,1470 # 58b8 <malloc+0xbba>
    ...
    131c:	3e050513          	addi	a0,a0,992 # 56f8 <malloc+0x9fa>
    1320:	00004097          	auipc	ra,0x4
    1324:	920080e7          	jalr	-1760(ra) # 4c40 <printf>
    exit(1);
    1328:	4505                	li	a0,1
    ...
    1338:	40c50513          	addi	a0,a0,1036 # 5740 <malloc+0xa42>
    133c:	00004097          	auipc	ra,0x4
    1340:	904080e7          	jalr	-1788(ra) # 4c40 <printf>
    exit(1);
    1344:	4505                	li	a0,1
    ...
    1354:	45850513          	addi	a0,a0,1112 # 57a8 <malloc+0xaaa>
    1358:	00004097          	auipc	ra,0x4
    135c:	8e8080e7          	jalr	-1816(ra) # 4c40 <printf>
    exit(1);
    1360:	4505                	li	a0,1
    ...
    1370:	4b450513          	addi	a0,a0,1204 # 5820 <malloc+0xb22>
    1374:	00004097          	auipc	ra,0x4
    1378:	8cc080e7          	jalr	-1844(ra) # 4c40 <printf>
    exit(1);
    137c:	4505                	li	a0,1
    ...
    138c:	4f850513          	addi	a0,a0,1272 # 5880 <malloc+0xb82>
    1390:	00004097          	auipc	ra,0x4
    1394:	8b0080e7          	jalr	-1872(ra) # 4c40 <printf>
    exit(1);
    1398:	4505                	li	a0,1
    ...
    13a8:	53450513          	addi	a0,a0,1332 # 58d8 <malloc+0xbda>
    13ac:	00004097          	auipc	ra,0x4
    13b0:	894080e7          	jalr	-1900(ra) # 4c40 <printf>
    exit(1);
    13b4:	4505                	li	a0,1
...
00000000000013be <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    13ce:	54650513          	addi	a0,a0,1350 # 5910 <malloc+0xc12>
  ...
  if(chdir("iputdir") < 0){
    ...
    13e2:	53250513          	addi	a0,a0,1330 # 5910 <malloc+0xc12>
  ...
  if(unlink("../iputdir") < 0){
    ...
    13f6:	55e50513          	addi	a0,a0,1374 # 5950 <malloc+0xc52>
  ...
  if(chdir("/") < 0){
    ...
    140a:	57a50513          	addi	a0,a0,1402 # 5980 <malloc+0xc82>
    ...
    142a:	4f250513          	addi	a0,a0,1266 # 5918 <malloc+0xc1a>
    142e:	00004097          	auipc	ra,0x4
    1432:	812080e7          	jalr	-2030(ra) # 4c40 <printf>
    exit(1);
    1436:	4505                	li	a0,1
    ...
    1446:	4ee50513          	addi	a0,a0,1262 # 5930 <malloc+0xc32>
    144a:	00003097          	auipc	ra,0x3
    144e:	7f6080e7          	jalr	2038(ra) # 4c40 <printf>
    exit(1);
    1452:	4505                	li	a0,1
    ...
    1462:	50250513          	addi	a0,a0,1282 # 5960 <malloc+0xc62>
    1466:	00003097          	auipc	ra,0x3
    146a:	7da080e7          	jalr	2010(ra) # 4c40 <printf>
    exit(1);
    146e:	4505                	li	a0,1
    ...
    147e:	50e50513          	addi	a0,a0,1294 # 5988 <malloc+0xc8a>
    1482:	00003097          	auipc	ra,0x3
    1486:	7be080e7          	jalr	1982(ra) # 4c40 <printf>
    exit(1);
    148a:	4505                	li	a0,1
...
0000000000001494 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    14b2:	46250513          	addi	a0,a0,1122 # 5910 <malloc+0xc12>
    ...
    14c6:	44e50513          	addi	a0,a0,1102 # 5910 <malloc+0xc12>
    ...
    14da:	47a50513          	addi	a0,a0,1146 # 5950 <malloc+0xc52>
    ...
    14fa:	fda50513          	addi	a0,a0,-38 # 54d0 <malloc+0x7d2>
    14fe:	00003097          	auipc	ra,0x3
    1502:	742080e7          	jalr	1858(ra) # 4c40 <printf>
    exit(1);
    1506:	4505                	li	a0,1
    ...
    1516:	40650513          	addi	a0,a0,1030 # 5918 <malloc+0xc1a>
    151a:	00003097          	auipc	ra,0x3
    151e:	726080e7          	jalr	1830(ra) # 4c40 <printf>
      exit(1);
    1522:	4505                	li	a0,1
    ...
    1532:	47250513          	addi	a0,a0,1138 # 59a0 <malloc+0xca2>
    1536:	00003097          	auipc	ra,0x3
    153a:	70a080e7          	jalr	1802(ra) # 4c40 <printf>
      exit(1);
    153e:	4505                	li	a0,1
    ...
    154e:	41650513          	addi	a0,a0,1046 # 5960 <malloc+0xc62>
    1552:	00003097          	auipc	ra,0x3
    1556:	6ee080e7          	jalr	1774(ra) # 4c40 <printf>
      exit(1);
    155a:	4505                	li	a0,1
...
000000000000157c <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    158c:	43050513          	addi	a0,a0,1072 # 59b8 <malloc+0xcba>
  ...
  if(chdir("dots") != 0){
    ...
    159e:	41e50513          	addi	a0,a0,1054 # 59b8 <malloc+0xcba>
  ...
  if(unlink(".") == 0){
    ...
    15b0:	44450513          	addi	a0,a0,1092 # 59f0 <malloc+0xcf2>
  ...
  if(unlink("..") == 0){
    ...
    15c2:	45250513          	addi	a0,a0,1106 # 5a10 <malloc+0xd12>
  ...
  if(chdir("/") != 0){
    ...
    15d4:	3b050513          	addi	a0,a0,944 # 5980 <malloc+0xc82>
  ...
  if(unlink("dots/.") == 0){
    ...
    15e6:	44e50513          	addi	a0,a0,1102 # 5a30 <malloc+0xd32>
  ...
  if(unlink("dots/..") == 0){
    ...
    15f8:	46450513          	addi	a0,a0,1124 # 5a58 <malloc+0xd5a>
  ...
  if(unlink("dots") != 0){
    ...
    160a:	3b250513          	addi	a0,a0,946 # 59b8 <malloc+0xcba>
    ...
    1628:	39c50513          	addi	a0,a0,924 # 59c0 <malloc+0xcc2>
    162c:	00003097          	auipc	ra,0x3
    1630:	614080e7          	jalr	1556(ra) # 4c40 <printf>
    exit(1);
    1634:	4505                	li	a0,1
    ...
    1644:	39850513          	addi	a0,a0,920 # 59d8 <malloc+0xcda>
    1648:	00003097          	auipc	ra,0x3
    164c:	5f8080e7          	jalr	1528(ra) # 4c40 <printf>
    exit(1);
    1650:	4505                	li	a0,1
    ...
    1660:	39c50513          	addi	a0,a0,924 # 59f8 <malloc+0xcfa>
    1664:	00003097          	auipc	ra,0x3
    1668:	5dc080e7          	jalr	1500(ra) # 4c40 <printf>
    exit(1);
    166c:	4505                	li	a0,1
    ...
    167c:	3a050513          	addi	a0,a0,928 # 5a18 <malloc+0xd1a>
    1680:	00003097          	auipc	ra,0x3
    1684:	5c0080e7          	jalr	1472(ra) # 4c40 <printf>
    exit(1);
    1688:	4505                	li	a0,1
    ...
    1698:	2f450513          	addi	a0,a0,756 # 5988 <malloc+0xc8a>
    169c:	00003097          	auipc	ra,0x3
    16a0:	5a4080e7          	jalr	1444(ra) # 4c40 <printf>
    exit(1);
    16a4:	4505                	li	a0,1
    ...
    16b4:	38850513          	addi	a0,a0,904 # 5a38 <malloc+0xd3a>
    16b8:	00003097          	auipc	ra,0x3
    16bc:	588080e7          	jalr	1416(ra) # 4c40 <printf>
    exit(1);
    16c0:	4505                	li	a0,1
    ...
    16d0:	39450513          	addi	a0,a0,916 # 5a60 <malloc+0xd62>
    16d4:	00003097          	auipc	ra,0x3
    16d8:	56c080e7          	jalr	1388(ra) # 4c40 <printf>
    exit(1);
    16dc:	4505                	li	a0,1
    ...
    16ec:	39850513          	addi	a0,a0,920 # 5a80 <malloc+0xd82>
    16f0:	00003097          	auipc	ra,0x3
    16f4:	550080e7          	jalr	1360(ra) # 4c40 <printf>
    exit(1);
    16f8:	4505                	li	a0,1
...
0000000000001702 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    1712:	39250513          	addi	a0,a0,914 # 5aa0 <malloc+0xda2>
  ...
  if(pid == 0){
    ...
    1736:	36e50513          	addi	a0,a0,878 # 5aa0 <malloc+0xda2>
    ...
    174c:	37850513          	addi	a0,a0,888 # 5ac0 <malloc+0xdc2>
    1750:	00003097          	auipc	ra,0x3
    1754:	4f0080e7          	jalr	1264(ra) # 4c40 <printf>
      exit(1);
    1758:	4505                	li	a0,1
    ...
    1768:	34450513          	addi	a0,a0,836 # 5aa8 <malloc+0xdaa>
    176c:	00003097          	auipc	ra,0x3
    1770:	4d4080e7          	jalr	1236(ra) # 4c40 <printf>
    exit(1);
    1774:	4505                	li	a0,1
    ...
    1784:	d5050513          	addi	a0,a0,-688 # 54d0 <malloc+0x7d2>
    1788:	00003097          	auipc	ra,0x3
    178c:	4b8080e7          	jalr	1208(ra) # 4c40 <printf>
    exit(1);
    1790:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    17b2:	2f250513          	addi	a0,a0,754 # 5aa0 <malloc+0xda2>
    ...
    17c6:	e1650513          	addi	a0,a0,-490 # 55d8 <malloc+0x8da>
    17ca:	00003097          	auipc	ra,0x3
    17ce:	476080e7          	jalr	1142(ra) # 4c40 <printf>
    exit(1);
    17d2:	4505                	li	a0,1
...
00000000000017f4 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    1804:	2e850513          	addi	a0,a0,744 # 5ae8 <malloc+0xdea>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    1830:	2bc50513          	addi	a0,a0,700 # 5ae8 <malloc+0xdea>
  ...
  sleep(10); // one second
    ...
    1868:	d2c50513          	addi	a0,a0,-724 # 5590 <malloc+0x892>
    186c:	00003097          	auipc	ra,0x3
    1870:	3d4080e7          	jalr	980(ra) # 4c40 <printf>
    exit(1);
    1874:	4505                	li	a0,1
    ...
    1882:	26a48493          	addi	s1,s1,618 # 5ae8 <malloc+0xdea>
    1886:	4581                	li	a1,0
    1888:	8526                	mv	a0,s1
...
00000000000018c4 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    18d6:	8a678793          	addi	a5,a5,-1882 # 5178 <malloc+0x47a>
    18da:	fcf43023          	sd	a5,-64(s0)
    18de:	00004797          	auipc	a5,0x4
    18e2:	21a78793          	addi	a5,a5,538 # 5af8 <malloc+0xdfa>
    18e6:	fcf43423          	sd	a5,-56(s0)
    18ea:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    18ee:	00004517          	auipc	a0,0x4
    18f2:	21250513          	addi	a0,a0,530 # 5b00 <malloc+0xe02>
  ...
  if(pid == 0) {
    ...
    1920:	1e450513          	addi	a0,a0,484 # 5b00 <malloc+0xe02>
    ...
    193c:	1d050513          	addi	a0,a0,464 # 5b08 <malloc+0xe0a>
    1940:	00003097          	auipc	ra,0x3
    1944:	300080e7          	jalr	768(ra) # 4c40 <printf>
      exit(1);
    1948:	4505                	li	a0,1
    ...
    1958:	b7c50513          	addi	a0,a0,-1156 # 54d0 <malloc+0x7d2>
    195c:	00003097          	auipc	ra,0x3
    1960:	2e4080e7          	jalr	740(ra) # 4c40 <printf>
     exit(1);
    1964:	4505                	li	a0,1
    ...
    1974:	c5050513          	addi	a0,a0,-944 # 55c0 <malloc+0x8c2>
    1978:	00003097          	auipc	ra,0x3
    197c:	2c8080e7          	jalr	712(ra) # 4c40 <printf>
      exit(1);
    1980:	4505                	li	a0,1
    ...
    1992:	7ea50513          	addi	a0,a0,2026 # 5178 <malloc+0x47a>
  ...
  if(xstatus != 0)
    ...
    19c6:	15650513          	addi	a0,a0,342 # 5b18 <malloc+0xe1a>
    19ca:	00003097          	auipc	ra,0x3
    19ce:	276080e7          	jalr	630(ra) # 4c40 <printf>
      exit(1);
    19d2:	4505                	li	a0,1
    ...
    19e2:	15250513          	addi	a0,a0,338 # 5b30 <malloc+0xe32>
    19e6:	00003097          	auipc	ra,0x3
    19ea:	25a080e7          	jalr	602(ra) # 4c40 <printf>
    19ee:	b7d1                	j	19b2 <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    19f0:	4581                	li	a1,0
    19f2:	00004517          	auipc	a0,0x4
    19f6:	10e50513          	addi	a0,a0,270 # 5b00 <malloc+0xe02>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    1a20:	86c50513          	addi	a0,a0,-1940 # 5288 <malloc+0x58a>
    1a24:	00003097          	auipc	ra,0x3
    1a28:	21c080e7          	jalr	540(ra) # 4c40 <printf>
    exit(1);
    1a2c:	4505                	li	a0,1
    ...
    1a3c:	ab050513          	addi	a0,a0,-1360 # 54e8 <malloc+0x7ea>
    1a40:	00003097          	auipc	ra,0x3
    1a44:	200080e7          	jalr	512(ra) # 4c40 <printf>
    exit(1);
    1a48:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    1a56:	0ae50513          	addi	a0,a0,174 # 5b00 <malloc+0xe02>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1a80:	0cc50513          	addi	a0,a0,204 # 5b48 <malloc+0xe4a>
    1a84:	00003097          	auipc	ra,0x3
    1a88:	1bc080e7          	jalr	444(ra) # 4c40 <printf>
    exit(1);
    1a8c:	4505                	li	a0,1
...
0000000000001aa0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    1ab0:	0b450513          	addi	a0,a0,180 # 5b60 <malloc+0xe62>
  ...
  fd = open("bigarg-ok", 0);
    ...
    1ae2:	08250513          	addi	a0,a0,130 # 5b60 <malloc+0xe62>
  ...
  close(fd);
    ...
    1b08:	51478793          	addi	a5,a5,1300 # 7018 <args.1741>
    1b0c:	00005697          	auipc	a3,0x5
    1b10:	60468693          	addi	a3,a3,1540 # 7110 <args.1741+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    1b14:	00004717          	auipc	a4,0x4
    1b18:	05c70713          	addi	a4,a4,92 # 5b70 <malloc+0xe72>
    ...
    1b6c:	0e850513          	addi	a0,a0,232 # 5c50 <malloc+0xf52>
    1b70:	00003097          	auipc	ra,0x3
    1b74:	0d0080e7          	jalr	208(ra) # 4c40 <printf>
    exit(1);
    1b78:	4505                	li	a0,1
    ...
    1b90:	0e450513          	addi	a0,a0,228 # 5c70 <malloc+0xf72>
    1b94:	00003097          	auipc	ra,0x3
    1b98:	0ac080e7          	jalr	172(ra) # 4c40 <printf>
    exit(1);
    1b9c:	4505                	li	a0,1
...
badarg(char *s)
{
    ...
    1bb6:	35048493          	addi	s1,s1,848 # c350 <buf+0x2b28>
  for(int i = 0; i < 50000; i++){
    ...
    1bc4:	5b898993          	addi	s3,s3,1464 # 5178 <malloc+0x47a>
    argv[0] = (char*)0xffffffff;
...
0000000000001bec <pipe1>:
{
  ...
  if(pid == 0){
    ...
    1c38:	bf4a8a93          	addi	s5,s5,-1036 # 9828 <buf>
      if(cc > sizeof(buf))
    ...
    1c56:	bd670713          	addi	a4,a4,-1066 # 9828 <buf>
    ...
    1c8e:	00650513          	addi	a0,a0,6 # 5c90 <malloc+0xf92>
    1c92:	00003097          	auipc	ra,0x3
    1c96:	fae080e7          	jalr	-82(ra) # 4c40 <printf>
    exit(1);
    1c9a:	4505                	li	a0,1
    ...
    1cb4:	b78b0b13          	addi	s6,s6,-1160 # 9828 <buf>
    ...
    1cc8:	42da8a93          	addi	s5,s5,1069 # 142d <iputtest+0x6f>
{
    ...
    1d14:	f9850513          	addi	a0,a0,-104 # 5ca8 <malloc+0xfaa>
    1d18:	00003097          	auipc	ra,0x3
    1d1c:	f28080e7          	jalr	-216(ra) # 4c40 <printf>
        exit(1);
    1d20:	4505                	li	a0,1
    ...
    1d30:	f9450513          	addi	a0,a0,-108 # 5cc0 <malloc+0xfc2>
    1d34:	00003097          	auipc	ra,0x3
    1d38:	f0c080e7          	jalr	-244(ra) # 4c40 <printf>
}
    ...
    1d62:	f7a50513          	addi	a0,a0,-134 # 5cd8 <malloc+0xfda>
    1d66:	00003097          	auipc	ra,0x3
    1d6a:	eda080e7          	jalr	-294(ra) # 4c40 <printf>
      exit(1);
    1d6e:	4505                	li	a0,1
    ...
    1da2:	f5a50513          	addi	a0,a0,-166 # 5cf8 <malloc+0xffa>
    1da6:	00003097          	auipc	ra,0x3
    1daa:	e9a080e7          	jalr	-358(ra) # 4c40 <printf>
    exit(1);
    1dae:	4505                	li	a0,1
...
0000000000001db8 <pgbug>:
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1dca:	2324b483          	ld	s1,562(s1) # 6ff8 <__SDATA_BEGIN__>
...
0000000000001df0 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    1e18:	77c50513          	addi	a0,a0,1916 # 5590 <malloc+0x892>
    1e1c:	00003097          	auipc	ra,0x3
    1e20:	e24080e7          	jalr	-476(ra) # 4c40 <printf>
    exit(1);
    1e24:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    1e46:	68e50513          	addi	a0,a0,1678 # 54d0 <malloc+0x7d2>
    1e4a:	00003097          	auipc	ra,0x3
    1e4e:	df6080e7          	jalr	-522(ra) # 4c40 <printf>
    exit(1);
    1e52:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    1e8a:	2c258593          	addi	a1,a1,706 # 5148 <malloc+0x44a>
    ...
    1eb4:	62050513          	addi	a0,a0,1568 # 54d0 <malloc+0x7d2>
    1eb8:	00003097          	auipc	ra,0x3
    1ebc:	d88080e7          	jalr	-632(ra) # 4c40 <printf>
     exit(1);
    1ec0:	4505                	li	a0,1
    ...
    1ece:	e4650513          	addi	a0,a0,-442 # 5d10 <malloc+0x1012>
    1ed2:	00003097          	auipc	ra,0x3
    1ed6:	d6e080e7          	jalr	-658(ra) # 4c40 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    1eee:	93e58593          	addi	a1,a1,-1730 # 9828 <buf>
    ...
    1f08:	e2450513          	addi	a0,a0,-476 # 5d28 <malloc+0x102a>
    1f0c:	00003097          	auipc	ra,0x3
    1f10:	d34080e7          	jalr	-716(ra) # 4c40 <printf>
}
  ...
  printf("kill... ");
    ...
    1f34:	e1050513          	addi	a0,a0,-496 # 5d40 <malloc+0x1042>
    1f38:	00003097          	auipc	ra,0x3
    1f3c:	d08080e7          	jalr	-760(ra) # 4c40 <printf>
  kill(pid1);
    1f40:	854e                	mv	a0,s3
  ...
  printf("wait... ");
    ...
    1f62:	df250513          	addi	a0,a0,-526 # 5d50 <malloc+0x1052>
    1f66:	00003097          	auipc	ra,0x3
    1f6a:	cda080e7          	jalr	-806(ra) # 4c40 <printf>
  wait(0);
    1f6e:	4501                	li	a0,0
...
0000000000001f8e <reparent>:
{
  ...
  exit(0);
    ...
    1fe2:	4f250513          	addi	a0,a0,1266 # 54d0 <malloc+0x7d2>
    1fe6:	00003097          	auipc	ra,0x3
    1fea:	c5a080e7          	jalr	-934(ra) # 4c40 <printf>
      exit(1);
    1fee:	4505                	li	a0,1
    ...
    1ffe:	55e50513          	addi	a0,a0,1374 # 5558 <malloc+0x85a>
    2002:	00003097          	auipc	ra,0x3
    2006:	c3e080e7          	jalr	-962(ra) # 4c40 <printf>
        exit(1);
    200a:	4505                	li	a0,1
...
000000000000203e <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    20d4:	c9050513          	addi	a0,a0,-880 # 5d60 <malloc+0x1062>
    20d8:	00003097          	auipc	ra,0x3
    20dc:	b68080e7          	jalr	-1176(ra) # 4c40 <printf>
    exit(1);
    20e0:	4505                	li	a0,1
    ...
    20f0:	c9c50513          	addi	a0,a0,-868 # 5d88 <malloc+0x108a>
    20f4:	00003097          	auipc	ra,0x3
    20f8:	b4c080e7          	jalr	-1204(ra) # 4c40 <printf>
      exit(1);
    20fc:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    2134:	df050513          	addi	a0,a0,-528 # 4f20 <malloc+0x222>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    2174:	c3850513          	addi	a0,a0,-968 # 5da8 <malloc+0x10aa>
    2178:	00003097          	auipc	ra,0x3
    217c:	ac8080e7          	jalr	-1336(ra) # 4c40 <printf>
    exit(1);
    2180:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    21b0:	d7450513          	addi	a0,a0,-652 # 4f20 <malloc+0x222>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    21d6:	bfe50513          	addi	a0,a0,-1026 # 5dd0 <malloc+0x10d2>
    21da:	00003097          	auipc	ra,0x3
    21de:	a66080e7          	jalr	-1434(ra) # 4c40 <printf>
    exit(1);
    21e2:	4505                	li	a0,1
...
00000000000021f6 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    221a:	bd278793          	addi	a5,a5,-1070 # 4de8 <malloc+0xea>
    221e:	f6f43823          	sd	a5,-144(s0)
    2222:	00003797          	auipc	a5,0x3
    2226:	bce78793          	addi	a5,a5,-1074 # 4df0 <malloc+0xf2>
    222a:	f6f43c23          	sd	a5,-136(s0)
    222e:	00003797          	auipc	a5,0x3
    2232:	bca78793          	addi	a5,a5,-1078 # 4df8 <malloc+0xfa>
    2236:	f8f43023          	sd	a5,-128(s0)
    223a:	00003797          	auipc	a5,0x3
    223e:	bc678793          	addi	a5,a5,-1082 # 4e00 <malloc+0x102>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    2298:	594a0a13          	addi	s4,s4,1428 # 9828 <buf>
    229c:	00007a97          	auipc	s5,0x7
    22a0:	58da8a93          	addi	s5,s5,1421 # 9829 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    22b6:	9ae50513          	addi	a0,a0,-1618 # 5c60 <malloc+0xf62>
    22ba:	00003097          	auipc	ra,0x3
    22be:	986080e7          	jalr	-1658(ra) # 4c40 <printf>
      exit(1);
    22c2:	4505                	li	a0,1
    ...
    2330:	abc50513          	addi	a0,a0,-1348 # 5de8 <malloc+0x10ea>
    2334:	00003097          	auipc	ra,0x3
    2338:	90c080e7          	jalr	-1780(ra) # 4c40 <printf>
        exit(1);
    233c:	4505                	li	a0,1
    ...
    234a:	ab250513          	addi	a0,a0,-1358 # 5df8 <malloc+0x10fa>
    234e:	00003097          	auipc	ra,0x3
    2352:	8f2080e7          	jalr	-1806(ra) # 4c40 <printf>
          exit(1);
    2356:	4505                	li	a0,1
    ...
    236e:	aa650513          	addi	a0,a0,-1370 # 5e10 <malloc+0x1112>
    2372:	00003097          	auipc	ra,0x3
    2376:	8ce080e7          	jalr	-1842(ra) # 4c40 <printf>
          exit(1);
    237a:	4505                	li	a0,1
    ...
    239e:	48e78793          	addi	a5,a5,1166 # 9828 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    23fe:	a2650513          	addi	a0,a0,-1498 # 5e20 <malloc+0x1122>
    2402:	00003097          	auipc	ra,0x3
    2406:	83e080e7          	jalr	-1986(ra) # 4c40 <printf>
      exit(1);
    240a:	4505                	li	a0,1
...
0000000000002432 <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    2472:	3ba90913          	addi	s2,s2,954 # 9828 <buf>
  for(i = 0; i < N; i++){
    2476:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile", 0);
    ...
    24ba:	ba250513          	addi	a0,a0,-1118 # 5058 <malloc+0x35a>
  ...
  for(i = 0; ; i++){
    ...
    24d0:	35c90913          	addi	s2,s2,860 # 9828 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    251e:	91e50513          	addi	a0,a0,-1762 # 5e38 <malloc+0x113a>
    2522:	00002097          	auipc	ra,0x2
    2526:	71e080e7          	jalr	1822(ra) # 4c40 <printf>
    exit(1);
    252a:	4505                	li	a0,1
    ...
    253a:	92250513          	addi	a0,a0,-1758 # 5e58 <malloc+0x115a>
    253e:	00002097          	auipc	ra,0x2
    2542:	702080e7          	jalr	1794(ra) # 4c40 <printf>
      exit(1);
    2546:	4505                	li	a0,1
    ...
    2556:	92650513          	addi	a0,a0,-1754 # 5e78 <malloc+0x117a>
    255a:	00002097          	auipc	ra,0x2
    255e:	6e6080e7          	jalr	1766(ra) # 4c40 <printf>
    exit(1);
    2562:	4505                	li	a0,1
    ...
    2572:	92a50513          	addi	a0,a0,-1750 # 5e98 <malloc+0x119a>
    2576:	00002097          	auipc	ra,0x2
    257a:	6ca080e7          	jalr	1738(ra) # 4c40 <printf>
      exit(1);
    257e:	4505                	li	a0,1
    ...
    258e:	92e50513          	addi	a0,a0,-1746 # 5eb8 <malloc+0x11ba>
    2592:	00002097          	auipc	ra,0x2
    2596:	6ae080e7          	jalr	1710(ra) # 4c40 <printf>
      exit(1);
    259a:	4505                	li	a0,1
    ...
    25aa:	92a50513          	addi	a0,a0,-1750 # 5ed0 <malloc+0x11d2>
    25ae:	00002097          	auipc	ra,0x2
    25b2:	692080e7          	jalr	1682(ra) # 4c40 <printf>
      exit(1);
    25b6:	4505                	li	a0,1
  ...
  unlink("bigfile");
    ...
    25d8:	a8450513          	addi	a0,a0,-1404 # 5058 <malloc+0x35a>
    ...
    25fc:	8f850513          	addi	a0,a0,-1800 # 5ef0 <malloc+0x11f2>
    2600:	00002097          	auipc	ra,0x2
    2604:	640080e7          	jalr	1600(ra) # 4c40 <printf>
    exit(1);
    2608:	4505                	li	a0,1
...
0000000000002612 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
    ...
    2660:	d7458593          	addi	a1,a1,-652 # 53d0 <malloc+0x6d2>
  ...
  if(link("lf1", "lf2") < 0){
    ...
    2680:	89c58593          	addi	a1,a1,-1892 # 5f18 <malloc+0x121a>
    2684:	00004517          	auipc	a0,0x4
    2688:	88c50513          	addi	a0,a0,-1908 # 5f10 <malloc+0x1212>
  ...
  unlink("lf1");
    ...
    269c:	87850513          	addi	a0,a0,-1928 # 5f10 <malloc+0x1212>
    26a0:	00002097          	auipc	ra,0x2
    26a4:	268080e7          	jalr	616(ra) # 4908 <unlink>
  if(open("lf1", 0) >= 0){
    26a8:	4581                	li	a1,0
    26aa:	00004517          	auipc	a0,0x4
    26ae:	86650513          	addi	a0,a0,-1946 # 5f10 <malloc+0x1212>
  ...
  fd = open("lf2", 0);
    ...
    26c4:	85850513          	addi	a0,a0,-1960 # 5f18 <malloc+0x121a>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
    ...
    26dc:	15058593          	addi	a1,a1,336 # 9828 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    26fc:	82058593          	addi	a1,a1,-2016 # 5f18 <malloc+0x121a>
    2700:	852e                	mv	a0,a1
  ...
  unlink("lf2");
    ...
    2712:	80a50513          	addi	a0,a0,-2038 # 5f18 <malloc+0x121a>
    2716:	00002097          	auipc	ra,0x2
    271a:	1f2080e7          	jalr	498(ra) # 4908 <unlink>
  if(link("lf2", "lf1") >= 0){
    271e:	00003597          	auipc	a1,0x3
    2722:	7f258593          	addi	a1,a1,2034 # 5f10 <malloc+0x1212>
    2726:	00003517          	auipc	a0,0x3
    272a:	7f250513          	addi	a0,a0,2034 # 5f18 <malloc+0x121a>
  ...
  if(link(".", "lf1") >= 0){
    ...
    273e:	7d658593          	addi	a1,a1,2006 # 5f10 <malloc+0x1212>
    2742:	00003517          	auipc	a0,0x3
    2746:	2ae50513          	addi	a0,a0,686 # 59f0 <malloc+0xcf2>
    ...
    2768:	7bc50513          	addi	a0,a0,1980 # 5f20 <malloc+0x1222>
    276c:	00002097          	auipc	ra,0x2
    2770:	4d4080e7          	jalr	1236(ra) # 4c40 <printf>
    exit(1);
    2774:	4505                	li	a0,1
    ...
    2784:	7b850513          	addi	a0,a0,1976 # 5f38 <malloc+0x123a>
    2788:	00002097          	auipc	ra,0x2
    278c:	4b8080e7          	jalr	1208(ra) # 4c40 <printf>
    exit(1);
    2790:	4505                	li	a0,1
    ...
    27a0:	7b450513          	addi	a0,a0,1972 # 5f50 <malloc+0x1252>
    27a4:	00002097          	auipc	ra,0x2
    27a8:	49c080e7          	jalr	1180(ra) # 4c40 <printf>
    exit(1);
    27ac:	4505                	li	a0,1
    ...
    27bc:	7b850513          	addi	a0,a0,1976 # 5f70 <malloc+0x1272>
    27c0:	00002097          	auipc	ra,0x2
    27c4:	480080e7          	jalr	1152(ra) # 4c40 <printf>
    exit(1);
    27c8:	4505                	li	a0,1
    ...
    27d8:	7cc50513          	addi	a0,a0,1996 # 5fa0 <malloc+0x12a2>
    27dc:	00002097          	auipc	ra,0x2
    27e0:	464080e7          	jalr	1124(ra) # 4c40 <printf>
    exit(1);
    27e4:	4505                	li	a0,1
    ...
    27f4:	7c850513          	addi	a0,a0,1992 # 5fb8 <malloc+0x12ba>
    27f8:	00002097          	auipc	ra,0x2
    27fc:	448080e7          	jalr	1096(ra) # 4c40 <printf>
    exit(1);
    2800:	4505                	li	a0,1
    ...
    2810:	7c450513          	addi	a0,a0,1988 # 5fd0 <malloc+0x12d2>
    2814:	00002097          	auipc	ra,0x2
    2818:	42c080e7          	jalr	1068(ra) # 4c40 <printf>
    exit(1);
    281c:	4505                	li	a0,1
    ...
    282c:	7d050513          	addi	a0,a0,2000 # 5ff8 <malloc+0x12fa>
    2830:	00002097          	auipc	ra,0x2
    2834:	410080e7          	jalr	1040(ra) # 4c40 <printf>
    exit(1);
    2838:	4505                	li	a0,1
    ...
    2842:	85ca                	mv	a1,s2
    2844:	00003517          	auipc	a0,0x3
    2848:	7dc50513          	addi	a0,a0,2012 # 6020 <malloc+0x1322>
    284c:	00002097          	auipc	ra,0x2
    2850:	3f4080e7          	jalr	1012(ra) # 4c40 <printf>
    exit(1);
    2854:	4505                	li	a0,1
...
000000000000285e <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    288c:	7b8b8b93          	addi	s7,s7,1976 # 6040 <malloc+0x1342>
  for(i = 0; i < N; i++){
    ...
    28ce:	77e50513          	addi	a0,a0,1918 # 6048 <malloc+0x134a>
    28d2:	00002097          	auipc	ra,0x2
    28d6:	36e080e7          	jalr	878(ra) # 4c40 <printf>
        exit(1);
    28da:	4505                	li	a0,1
    ...
    28ec:	75850513          	addi	a0,a0,1880 # 6040 <malloc+0x1342>
  ...
  fd = open(".", 0);
    ...
    2924:	0d050513          	addi	a0,a0,208 # 59f0 <malloc+0xcf2>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    294a:	72250513          	addi	a0,a0,1826 # 6068 <malloc+0x136a>
    294e:	00002097          	auipc	ra,0x2
    2952:	2f2080e7          	jalr	754(ra) # 4c40 <printf>
        exit(1);
    2956:	4505                	li	a0,1
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    29ba:	6d250513          	addi	a0,a0,1746 # 6088 <malloc+0x138a>
    29be:	00002097          	auipc	ra,0x2
    29c2:	282080e7          	jalr	642(ra) # 4c40 <printf>
        exit(1);
    29c6:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    29f2:	6c250513          	addi	a0,a0,1730 # 60b0 <malloc+0x13b2>
    29f6:	00002097          	auipc	ra,0x2
    29fa:	24a080e7          	jalr	586(ra) # 4c40 <printf>
    exit(1);
    29fe:	4505                	li	a0,1
    ...
    2a0e:	ac650513          	addi	a0,a0,-1338 # 54d0 <malloc+0x7d2>
    2a12:	00002097          	auipc	ra,0x2
    2a16:	22e080e7          	jalr	558(ra) # 4c40 <printf>
      exit(1);
    2a1a:	4505                	li	a0,1
...
0000000000002b74 <linkunlink>:
{
  ...
  unlink("x");
    ...
    2b94:	5b850513          	addi	a0,a0,1464 # 5148 <malloc+0x44a>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    2bd0:	57ca8a93          	addi	s5,s5,1404 # 5148 <malloc+0x44a>
      link("cat", "x");
    2bd4:	00003b97          	auipc	s7,0x3
    2bd8:	514b8b93          	addi	s7,s7,1300 # 60e8 <malloc+0x13ea>
    2bdc:	a091                	j	2c20 <linkunlink+0xac>
    printf("%s: fork failed\n", s);
    2bde:	85a6                	mv	a1,s1
    2be0:	00003517          	auipc	a0,0x3
    2be4:	8f050513          	addi	a0,a0,-1808 # 54d0 <malloc+0x7d2>
    2be8:	00002097          	auipc	ra,0x2
    2bec:	058080e7          	jalr	88(ra) # 4c40 <printf>
    exit(1);
    2bf0:	4505                	li	a0,1
...
0000000000002c76 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    2cc6:	42ea0a13          	addi	s4,s4,1070 # 60f0 <malloc+0x13f2>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    2d18:	3dc50513          	addi	a0,a0,988 # 60f0 <malloc+0x13f2>
  ...
  for(i = 0; i < N; i++){
    ...
    2d88:	37450513          	addi	a0,a0,884 # 60f8 <malloc+0x13fa>
    2d8c:	00002097          	auipc	ra,0x2
    2d90:	eb4080e7          	jalr	-332(ra) # 4c40 <printf>
    exit(1);
    2d94:	4505                	li	a0,1
    ...
    2da4:	37850513          	addi	a0,a0,888 # 6118 <malloc+0x141a>
    2da8:	00002097          	auipc	ra,0x2
    2dac:	e98080e7          	jalr	-360(ra) # 4c40 <printf>
      exit(1);
    2db0:	4505                	li	a0,1
    ...
    2dc0:	37450513          	addi	a0,a0,884 # 6130 <malloc+0x1432>
    2dc4:	00002097          	auipc	ra,0x2
    2dc8:	e7c080e7          	jalr	-388(ra) # 4c40 <printf>
      exit(1);
    2dcc:	4505                	li	a0,1
...
0000000000002dd6 <subdir>:
{
  ...
  unlink("ff");
    ...
    2de8:	49c50513          	addi	a0,a0,1180 # 6280 <malloc+0x1582>
    2dec:	00002097          	auipc	ra,0x2
    2df0:	b1c080e7          	jalr	-1252(ra) # 4908 <unlink>
  if(mkdir("dd") != 0){
    2df4:	00003517          	auipc	a0,0x3
    2df8:	35c50513          	addi	a0,a0,860 # 6150 <malloc+0x1452>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    2e10:	36450513          	addi	a0,a0,868 # 6170 <malloc+0x1472>
  ...
  write(fd, "ff", 2);
    ...
    2e28:	45c58593          	addi	a1,a1,1116 # 6280 <malloc+0x1582>
  ...
  if(unlink("dd") >= 0){
    ...
    2e42:	31250513          	addi	a0,a0,786 # 6150 <malloc+0x1452>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    2e56:	37650513          	addi	a0,a0,886 # 61c8 <malloc+0x14ca>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2e6e:	38650513          	addi	a0,a0,902 # 61f0 <malloc+0x14f2>
  ...
  write(fd, "FF", 2);
    ...
    2e86:	39e58593          	addi	a1,a1,926 # 6220 <malloc+0x1522>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2ea2:	38a50513          	addi	a0,a0,906 # 6228 <malloc+0x152a>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    2eba:	97258593          	addi	a1,a1,-1678 # 9828 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    2ed0:	95c74703          	lbu	a4,-1700(a4) # 9828 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    2eea:	39258593          	addi	a1,a1,914 # 6278 <malloc+0x157a>
    2eee:	00003517          	auipc	a0,0x3
    2ef2:	30250513          	addi	a0,a0,770 # 61f0 <malloc+0x14f2>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    2f06:	2ee50513          	addi	a0,a0,750 # 61f0 <malloc+0x14f2>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2f1c:	2d850513          	addi	a0,a0,728 # 61f0 <malloc+0x14f2>
  ...
  if(chdir("dd") != 0){
    ...
    2f30:	22450513          	addi	a0,a0,548 # 6150 <malloc+0x1452>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    2f44:	3d050513          	addi	a0,a0,976 # 6310 <malloc+0x1612>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    2f58:	3ec50513          	addi	a0,a0,1004 # 6340 <malloc+0x1642>
  ...
  if(chdir("./..") != 0){
    ...
    2f6c:	40850513          	addi	a0,a0,1032 # 6370 <malloc+0x1672>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    2f82:	2fa50513          	addi	a0,a0,762 # 6278 <malloc+0x157a>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    2f9a:	89258593          	addi	a1,a1,-1902 # 9828 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2fbc:	23850513          	addi	a0,a0,568 # 61f0 <malloc+0x14f2>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2fd4:	43050513          	addi	a0,a0,1072 # 6400 <malloc+0x1702>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2fec:	44850513          	addi	a0,a0,1096 # 6430 <malloc+0x1732>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    3004:	15050513          	addi	a0,a0,336 # 6150 <malloc+0x1452>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    301a:	13a50513          	addi	a0,a0,314 # 6150 <malloc+0x1452>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    3030:	12450513          	addi	a0,a0,292 # 6150 <malloc+0x1452>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3044:	48058593          	addi	a1,a1,1152 # 64c0 <malloc+0x17c2>
    3048:	00003517          	auipc	a0,0x3
    304c:	3b850513          	addi	a0,a0,952 # 6400 <malloc+0x1702>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3060:	46458593          	addi	a1,a1,1124 # 64c0 <malloc+0x17c2>
    3064:	00003517          	auipc	a0,0x3
    3068:	3cc50513          	addi	a0,a0,972 # 6430 <malloc+0x1732>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    307c:	20058593          	addi	a1,a1,512 # 6278 <malloc+0x157a>
    3080:	00003517          	auipc	a0,0x3
    3084:	0f050513          	addi	a0,a0,240 # 6170 <malloc+0x1472>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    3098:	36c50513          	addi	a0,a0,876 # 6400 <malloc+0x1702>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    30ac:	38850513          	addi	a0,a0,904 # 6430 <malloc+0x1732>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    30c0:	1bc50513          	addi	a0,a0,444 # 6278 <malloc+0x157a>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    30d4:	36050513          	addi	a0,a0,864 # 6430 <malloc+0x1732>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    30e8:	31c50513          	addi	a0,a0,796 # 6400 <malloc+0x1702>
  ...
  if(chdir("dd/ff") == 0){
    ...
    30fc:	07850513          	addi	a0,a0,120 # 6170 <malloc+0x1472>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3110:	50450513          	addi	a0,a0,1284 # 6610 <malloc+0x1912>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    3124:	15850513          	addi	a0,a0,344 # 6278 <malloc+0x157a>
  ...
  if(unlink("dd/ff") != 0){
    ...
    3138:	03c50513          	addi	a0,a0,60 # 6170 <malloc+0x1472>
  ...
  if(unlink("dd") == 0){
    ...
    314c:	00850513          	addi	a0,a0,8 # 6150 <malloc+0x1452>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3160:	52450513          	addi	a0,a0,1316 # 6680 <malloc+0x1982>
  ...
  if(unlink("dd") < 0){
    ...
    3174:	fe050513          	addi	a0,a0,-32 # 6150 <malloc+0x1452>
    ...
    3196:	fc650513          	addi	a0,a0,-58 # 6158 <malloc+0x145a>
    319a:	00002097          	auipc	ra,0x2
    319e:	aa6080e7          	jalr	-1370(ra) # 4c40 <printf>
    exit(1);
    31a2:	4505                	li	a0,1
    ...
    31b2:	fca50513          	addi	a0,a0,-54 # 6178 <malloc+0x147a>
    31b6:	00002097          	auipc	ra,0x2
    31ba:	a8a080e7          	jalr	-1398(ra) # 4c40 <printf>
    exit(1);
    31be:	4505                	li	a0,1
    ...
    31ce:	fce50513          	addi	a0,a0,-50 # 6198 <malloc+0x149a>
    31d2:	00002097          	auipc	ra,0x2
    31d6:	a6e080e7          	jalr	-1426(ra) # 4c40 <printf>
    exit(1);
    31da:	4505                	li	a0,1
    ...
    31ea:	fea50513          	addi	a0,a0,-22 # 61d0 <malloc+0x14d2>
    31ee:	00002097          	auipc	ra,0x2
    31f2:	a52080e7          	jalr	-1454(ra) # 4c40 <printf>
    exit(1);
    31f6:	4505                	li	a0,1
    ...
    3206:	ffe50513          	addi	a0,a0,-2 # 6200 <malloc+0x1502>
    320a:	00002097          	auipc	ra,0x2
    320e:	a36080e7          	jalr	-1482(ra) # 4c40 <printf>
    exit(1);
    3212:	4505                	li	a0,1
    ...
    3222:	01a50513          	addi	a0,a0,26 # 6238 <malloc+0x153a>
    3226:	00002097          	auipc	ra,0x2
    322a:	a1a080e7          	jalr	-1510(ra) # 4c40 <printf>
    exit(1);
    322e:	4505                	li	a0,1
    ...
    323e:	01e50513          	addi	a0,a0,30 # 6258 <malloc+0x155a>
    3242:	00002097          	auipc	ra,0x2
    3246:	9fe080e7          	jalr	-1538(ra) # 4c40 <printf>
    exit(1);
    324a:	4505                	li	a0,1
    ...
    325a:	03250513          	addi	a0,a0,50 # 6288 <malloc+0x158a>
    325e:	00002097          	auipc	ra,0x2
    3262:	9e2080e7          	jalr	-1566(ra) # 4c40 <printf>
    exit(1);
    3266:	4505                	li	a0,1
    ...
    3276:	03e50513          	addi	a0,a0,62 # 62b0 <malloc+0x15b2>
    327a:	00002097          	auipc	ra,0x2
    327e:	9c6080e7          	jalr	-1594(ra) # 4c40 <printf>
    exit(1);
    3282:	4505                	li	a0,1
    ...
    3292:	04250513          	addi	a0,a0,66 # 62d0 <malloc+0x15d2>
    3296:	00002097          	auipc	ra,0x2
    329a:	9aa080e7          	jalr	-1622(ra) # 4c40 <printf>
    exit(1);
    329e:	4505                	li	a0,1
    ...
    32ae:	04e50513          	addi	a0,a0,78 # 62f8 <malloc+0x15fa>
    32b2:	00002097          	auipc	ra,0x2
    32b6:	98e080e7          	jalr	-1650(ra) # 4c40 <printf>
    exit(1);
    32ba:	4505                	li	a0,1
    ...
    32ca:	05a50513          	addi	a0,a0,90 # 6320 <malloc+0x1622>
    32ce:	00002097          	auipc	ra,0x2
    32d2:	972080e7          	jalr	-1678(ra) # 4c40 <printf>
    exit(1);
    32d6:	4505                	li	a0,1
    ...
    32e6:	06e50513          	addi	a0,a0,110 # 6350 <malloc+0x1652>
    32ea:	00002097          	auipc	ra,0x2
    32ee:	956080e7          	jalr	-1706(ra) # 4c40 <printf>
    exit(1);
    32f2:	4505                	li	a0,1
    ...
    3302:	07a50513          	addi	a0,a0,122 # 6378 <malloc+0x167a>
    3306:	00002097          	auipc	ra,0x2
    330a:	93a080e7          	jalr	-1734(ra) # 4c40 <printf>
    exit(1);
    330e:	4505                	li	a0,1
    ...
    331e:	07650513          	addi	a0,a0,118 # 6390 <malloc+0x1692>
    3322:	00002097          	auipc	ra,0x2
    3326:	91e080e7          	jalr	-1762(ra) # 4c40 <printf>
    exit(1);
    332a:	4505                	li	a0,1
    ...
    333a:	07a50513          	addi	a0,a0,122 # 63b0 <malloc+0x16b2>
    333e:	00002097          	auipc	ra,0x2
    3342:	902080e7          	jalr	-1790(ra) # 4c40 <printf>
    exit(1);
    3346:	4505                	li	a0,1
    ...
    3356:	07e50513          	addi	a0,a0,126 # 63d0 <malloc+0x16d2>
    335a:	00002097          	auipc	ra,0x2
    335e:	8e6080e7          	jalr	-1818(ra) # 4c40 <printf>
    exit(1);
    3362:	4505                	li	a0,1
    ...
    3372:	0a250513          	addi	a0,a0,162 # 6410 <malloc+0x1712>
    3376:	00002097          	auipc	ra,0x2
    337a:	8ca080e7          	jalr	-1846(ra) # 4c40 <printf>
    exit(1);
    337e:	4505                	li	a0,1
    ...
    338e:	0b650513          	addi	a0,a0,182 # 6440 <malloc+0x1742>
    3392:	00002097          	auipc	ra,0x2
    3396:	8ae080e7          	jalr	-1874(ra) # 4c40 <printf>
    exit(1);
    339a:	4505                	li	a0,1
    ...
    33aa:	0ba50513          	addi	a0,a0,186 # 6460 <malloc+0x1762>
    33ae:	00002097          	auipc	ra,0x2
    33b2:	892080e7          	jalr	-1902(ra) # 4c40 <printf>
    exit(1);
    33b6:	4505                	li	a0,1
    ...
    33c6:	0be50513          	addi	a0,a0,190 # 6480 <malloc+0x1782>
    33ca:	00002097          	auipc	ra,0x2
    33ce:	876080e7          	jalr	-1930(ra) # 4c40 <printf>
    exit(1);
    33d2:	4505                	li	a0,1
    ...
    33e2:	0c250513          	addi	a0,a0,194 # 64a0 <malloc+0x17a2>
    33e6:	00002097          	auipc	ra,0x2
    33ea:	85a080e7          	jalr	-1958(ra) # 4c40 <printf>
    exit(1);
    33ee:	4505                	li	a0,1
    ...
    33fe:	0d650513          	addi	a0,a0,214 # 64d0 <malloc+0x17d2>
    3402:	00002097          	auipc	ra,0x2
    3406:	83e080e7          	jalr	-1986(ra) # 4c40 <printf>
    exit(1);
    340a:	4505                	li	a0,1
    ...
    341a:	0e250513          	addi	a0,a0,226 # 64f8 <malloc+0x17fa>
    341e:	00002097          	auipc	ra,0x2
    3422:	822080e7          	jalr	-2014(ra) # 4c40 <printf>
    exit(1);
    3426:	4505                	li	a0,1
    ...
    3436:	0ee50513          	addi	a0,a0,238 # 6520 <malloc+0x1822>
    343a:	00002097          	auipc	ra,0x2
    343e:	806080e7          	jalr	-2042(ra) # 4c40 <printf>
    exit(1);
    3442:	4505                	li	a0,1
    ...
    3452:	0fa50513          	addi	a0,a0,250 # 6548 <malloc+0x184a>
    3456:	00001097          	auipc	ra,0x1
    345a:	7ea080e7          	jalr	2026(ra) # 4c40 <printf>
    exit(1);
    345e:	4505                	li	a0,1
    ...
    346e:	0fe50513          	addi	a0,a0,254 # 6568 <malloc+0x186a>
    3472:	00001097          	auipc	ra,0x1
    3476:	7ce080e7          	jalr	1998(ra) # 4c40 <printf>
    exit(1);
    347a:	4505                	li	a0,1
    ...
    348a:	10250513          	addi	a0,a0,258 # 6588 <malloc+0x188a>
    348e:	00001097          	auipc	ra,0x1
    3492:	7b2080e7          	jalr	1970(ra) # 4c40 <printf>
    exit(1);
    3496:	4505                	li	a0,1
    ...
    34a6:	10e50513          	addi	a0,a0,270 # 65b0 <malloc+0x18b2>
    34aa:	00001097          	auipc	ra,0x1
    34ae:	796080e7          	jalr	1942(ra) # 4c40 <printf>
    exit(1);
    34b2:	4505                	li	a0,1
    ...
    34c2:	11250513          	addi	a0,a0,274 # 65d0 <malloc+0x18d2>
    34c6:	00001097          	auipc	ra,0x1
    34ca:	77a080e7          	jalr	1914(ra) # 4c40 <printf>
    exit(1);
    34ce:	4505                	li	a0,1
    ...
    34de:	11650513          	addi	a0,a0,278 # 65f0 <malloc+0x18f2>
    34e2:	00001097          	auipc	ra,0x1
    34e6:	75e080e7          	jalr	1886(ra) # 4c40 <printf>
    exit(1);
    34ea:	4505                	li	a0,1
    ...
    34fa:	12250513          	addi	a0,a0,290 # 6618 <malloc+0x191a>
    34fe:	00001097          	auipc	ra,0x1
    3502:	742080e7          	jalr	1858(ra) # 4c40 <printf>
    exit(1);
    3506:	4505                	li	a0,1
    ...
    3516:	d9e50513          	addi	a0,a0,-610 # 62b0 <malloc+0x15b2>
    351a:	00001097          	auipc	ra,0x1
    351e:	726080e7          	jalr	1830(ra) # 4c40 <printf>
    exit(1);
    3522:	4505                	li	a0,1
    ...
    3532:	10a50513          	addi	a0,a0,266 # 6638 <malloc+0x193a>
    3536:	00001097          	auipc	ra,0x1
    353a:	70a080e7          	jalr	1802(ra) # 4c40 <printf>
    exit(1);
    353e:	4505                	li	a0,1
    ...
    354e:	10e50513          	addi	a0,a0,270 # 6658 <malloc+0x195a>
    3552:	00001097          	auipc	ra,0x1
    3556:	6ee080e7          	jalr	1774(ra) # 4c40 <printf>
    exit(1);
    355a:	4505                	li	a0,1
    ...
    356a:	12250513          	addi	a0,a0,290 # 6688 <malloc+0x198a>
    356e:	00001097          	auipc	ra,0x1
    3572:	6d2080e7          	jalr	1746(ra) # 4c40 <printf>
    exit(1);
    3576:	4505                	li	a0,1
    ...
    3586:	12650513          	addi	a0,a0,294 # 66a8 <malloc+0x19aa>
    358a:	00001097          	auipc	ra,0x1
    358e:	6b6080e7          	jalr	1718(ra) # 4c40 <printf>
    exit(1);
    3592:	4505                	li	a0,1
...
000000000000359c <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    35b2:	ab250513          	addi	a0,a0,-1358 # 5060 <malloc+0x362>
  ...
  if(chdir("dirfile") == 0){
    ...
    35ce:	a9650513          	addi	a0,a0,-1386 # 5060 <malloc+0x362>
  ...
  fd = open("dirfile/xx", 0);
    ...
    35e2:	12250513          	addi	a0,a0,290 # 6700 <malloc+0x1a02>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    35fa:	10a50513          	addi	a0,a0,266 # 6700 <malloc+0x1a02>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    360e:	0f650513          	addi	a0,a0,246 # 6700 <malloc+0x1a02>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3622:	0e250513          	addi	a0,a0,226 # 6700 <malloc+0x1a02>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3636:	0ce58593          	addi	a1,a1,206 # 6700 <malloc+0x1a02>
    363a:	00003517          	auipc	a0,0x3
    363e:	14e50513          	addi	a0,a0,334 # 6788 <malloc+0x1a8a>
  ...
  if(unlink("dirfile") != 0){
    ...
    3652:	a1250513          	addi	a0,a0,-1518 # 5060 <malloc+0x362>
  ...
  fd = open(".", O_RDWR);
    ...
    3668:	38c50513          	addi	a0,a0,908 # 59f0 <malloc+0xcf2>
  ...
  fd = open(".", 0);
    ...
    367e:	37650513          	addi	a0,a0,886 # 59f0 <malloc+0xcf2>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3692:	aba58593          	addi	a1,a1,-1350 # 5148 <malloc+0x44a>
  ...
  close(fd);
    ...
    36be:	00650513          	addi	a0,a0,6 # 66c0 <malloc+0x19c2>
    36c2:	00001097          	auipc	ra,0x1
    36c6:	57e080e7          	jalr	1406(ra) # 4c40 <printf>
    exit(1);
    36ca:	4505                	li	a0,1
    ...
    36da:	00a50513          	addi	a0,a0,10 # 66e0 <malloc+0x19e2>
    36de:	00001097          	auipc	ra,0x1
    36e2:	562080e7          	jalr	1378(ra) # 4c40 <printf>
    exit(1);
    36e6:	4505                	li	a0,1
    ...
    36f6:	01e50513          	addi	a0,a0,30 # 6710 <malloc+0x1a12>
    36fa:	00001097          	auipc	ra,0x1
    36fe:	546080e7          	jalr	1350(ra) # 4c40 <printf>
    exit(1);
    3702:	4505                	li	a0,1
    ...
    3712:	00250513          	addi	a0,a0,2 # 6710 <malloc+0x1a12>
    3716:	00001097          	auipc	ra,0x1
    371a:	52a080e7          	jalr	1322(ra) # 4c40 <printf>
    exit(1);
    371e:	4505                	li	a0,1
    ...
    372e:	00e50513          	addi	a0,a0,14 # 6738 <malloc+0x1a3a>
    3732:	00001097          	auipc	ra,0x1
    3736:	50e080e7          	jalr	1294(ra) # 4c40 <printf>
    exit(1);
    373a:	4505                	li	a0,1
    ...
    374a:	01a50513          	addi	a0,a0,26 # 6760 <malloc+0x1a62>
    374e:	00001097          	auipc	ra,0x1
    3752:	4f2080e7          	jalr	1266(ra) # 4c40 <printf>
    exit(1);
    3756:	4505                	li	a0,1
    ...
    3766:	02e50513          	addi	a0,a0,46 # 6790 <malloc+0x1a92>
    376a:	00001097          	auipc	ra,0x1
    376e:	4d6080e7          	jalr	1238(ra) # 4c40 <printf>
    exit(1);
    3772:	4505                	li	a0,1
    ...
    3782:	03a50513          	addi	a0,a0,58 # 67b8 <malloc+0x1aba>
    3786:	00001097          	auipc	ra,0x1
    378a:	4ba080e7          	jalr	1210(ra) # 4c40 <printf>
    exit(1);
    378e:	4505                	li	a0,1
    ...
    379e:	03e50513          	addi	a0,a0,62 # 67d8 <malloc+0x1ada>
    37a2:	00001097          	auipc	ra,0x1
    37a6:	49e080e7          	jalr	1182(ra) # 4c40 <printf>
    exit(1);
    37aa:	4505                	li	a0,1
    ...
    37ba:	04a50513          	addi	a0,a0,74 # 6800 <malloc+0x1b02>
    37be:	00001097          	auipc	ra,0x1
    37c2:	482080e7          	jalr	1154(ra) # 4c40 <printf>
    exit(1);
    37c6:	4505                	li	a0,1
...
00000000000037d0 <iref>:
{
    ...
    37ee:	02ea0a13          	addi	s4,s4,46 # 6818 <malloc+0x1b1a>
    mkdir("");
    37f2:	00003497          	auipc	s1,0x3
    37f6:	c0648493          	addi	s1,s1,-1018 # 63f8 <malloc+0x16fa>
    link("README", "");
    37fa:	00003a97          	auipc	s5,0x3
    37fe:	f8ea8a93          	addi	s5,s5,-114 # 6788 <malloc+0x1a8a>
    fd = open("xx", O_CREATE);
    3802:	00003997          	auipc	s3,0x3
    3806:	f0698993          	addi	s3,s3,-250 # 6708 <malloc+0x1a0a>
    380a:	a891                	j	385e <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    380c:	85da                	mv	a1,s6
    380e:	00003517          	auipc	a0,0x3
    3812:	01250513          	addi	a0,a0,18 # 6820 <malloc+0x1b22>
    3816:	00001097          	auipc	ra,0x1
    381a:	42a080e7          	jalr	1066(ra) # 4c40 <printf>
      exit(1);
    381e:	4505                	li	a0,1
    ...
    382e:	00e50513          	addi	a0,a0,14 # 6838 <malloc+0x1b3a>
    3832:	00001097          	auipc	ra,0x1
    3836:	40e080e7          	jalr	1038(ra) # 4c40 <printf>
      exit(1);
    383a:	4505                	li	a0,1
  ...
  chdir("/");
    ...
    38be:	0c650513          	addi	a0,a0,198 # 5980 <malloc+0xc82>
...
00000000000038de <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    38fa:	f5a98993          	addi	s3,s3,-166 # 6850 <malloc+0x1b52>
    38fe:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    3936:	f2e50513          	addi	a0,a0,-210 # 6860 <malloc+0x1b62>
    393a:	00001097          	auipc	ra,0x1
    393e:	306080e7          	jalr	774(ra) # 4c40 <printf>
      exit(1);
    3942:	4505                	li	a0,1
...
000000000000394c <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    3990:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f37c7>
  a = sbrk(0);
    3994:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    39f4:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f37c7>
  ...
  if(c != a){
    ...
    3a3c:	e4850513          	addi	a0,a0,-440 # 6880 <malloc+0x1b82>
    3a40:	00001097          	auipc	ra,0x1
    3a44:	200080e7          	jalr	512(ra) # 4c40 <printf>
    exit(1);
    3a48:	4505                	li	a0,1
    ...
    3a58:	e7450513          	addi	a0,a0,-396 # 68c8 <malloc+0x1bca>
    3a5c:	00001097          	auipc	ra,0x1
    3a60:	1e4080e7          	jalr	484(ra) # 4c40 <printf>
    exit(1);
    3a64:	4505                	li	a0,1
    ...
    3a76:	e7650513          	addi	a0,a0,-394 # 68e8 <malloc+0x1bea>
    3a7a:	00001097          	auipc	ra,0x1
    3a7e:	1c6080e7          	jalr	454(ra) # 4c40 <printf>
    exit(1);
    3a82:	4505                	li	a0,1
    ...
    3a94:	e9850513          	addi	a0,a0,-360 # 6928 <malloc+0x1c2a>
    3a98:	00001097          	auipc	ra,0x1
    3a9c:	1a8080e7          	jalr	424(ra) # 4c40 <printf>
    exit(1);
    3aa0:	4505                	li	a0,1
    ...
    3ab0:	eac50513          	addi	a0,a0,-340 # 6958 <malloc+0x1c5a>
    3ab4:	00001097          	auipc	ra,0x1
    3ab8:	18c080e7          	jalr	396(ra) # 4c40 <printf>
    exit(1);
    3abc:	4505                	li	a0,1
    ...
    3ace:	ec650513          	addi	a0,a0,-314 # 6990 <malloc+0x1c92>
    3ad2:	00001097          	auipc	ra,0x1
    3ad6:	16e080e7          	jalr	366(ra) # 4c40 <printf>
    exit(1);
    3ada:	4505                	li	a0,1
...
0000000000003ae4 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    3b1a:	17a50513          	addi	a0,a0,378 # 5c90 <malloc+0xf92>
    3b1e:	00001097          	auipc	ra,0x1
    3b22:	122080e7          	jalr	290(ra) # 4c40 <printf>
    exit(1);
    3b26:	4505                	li	a0,1
    ...
    3b50:	5fc58593          	addi	a1,a1,1532 # 5148 <malloc+0x44a>
  ...
  if(xstatus != -1)
    ...
    3c0e:	dae50513          	addi	a0,a0,-594 # 69b8 <malloc+0x1cba>
    3c12:	00001097          	auipc	ra,0x1
    3c16:	02e080e7          	jalr	46(ra) # 4c40 <printf>
    exit(1);
    3c1a:	4505                	li	a0,1
    ...
    3c2a:	8aa50513          	addi	a0,a0,-1878 # 54d0 <malloc+0x7d2>
    3c2e:	00001097          	auipc	ra,0x1
    3c32:	012080e7          	jalr	18(ra) # 4c40 <printf>
    exit(1);
    3c36:	4505                	li	a0,1
    ...
    3c74:	d6850513          	addi	a0,a0,-664 # 69d8 <malloc+0x1cda>
    3c78:	00001097          	auipc	ra,0x1
    3c7c:	fc8080e7          	jalr	-56(ra) # 4c40 <printf>
    exit(1);
    3c80:	4505                	li	a0,1
...
0000000000003c94 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    3cb8:	d5450513          	addi	a0,a0,-684 # 6a08 <malloc+0x1d0a>
    3cbc:	00001097          	auipc	ra,0x1
    3cc0:	c3c080e7          	jalr	-964(ra) # 48f8 <open>
    3cc4:	84aa                	mv	s1,a0
  unlink("sbrk");
    3cc6:	00003517          	auipc	a0,0x3
    3cca:	d4250513          	addi	a0,a0,-702 # 6a08 <malloc+0x1d0a>
  ...
  if(pipe((int *) a) != 0){
    ...
    3d1e:	cf650513          	addi	a0,a0,-778 # 6a10 <malloc+0x1d12>
    3d22:	00001097          	auipc	ra,0x1
    3d26:	f1e080e7          	jalr	-226(ra) # 4c40 <printf>
    exit(1);
    3d2a:	4505                	li	a0,1
    ...
    3d3a:	cf250513          	addi	a0,a0,-782 # 6a28 <malloc+0x1d2a>
    3d3e:	00001097          	auipc	ra,0x1
    3d42:	f02080e7          	jalr	-254(ra) # 4c40 <printf>
    exit(1);
    3d46:	4505                	li	a0,1
    ...
    3d56:	f3e50513          	addi	a0,a0,-194 # 5c90 <malloc+0xf92>
    3d5a:	00001097          	auipc	ra,0x1
    3d5e:	ee6080e7          	jalr	-282(ra) # 4c40 <printf>
    exit(1);
    3d62:	4505                	li	a0,1
...
0000000000003d6c <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    3d80:	cc450513          	addi	a0,a0,-828 # 6a40 <malloc+0x1d42>
  ...
  close(fd);
    ...
    3dc8:	72450513          	addi	a0,a0,1828 # 54e8 <malloc+0x7ea>
    3dcc:	00001097          	auipc	ra,0x1
    3dd0:	e74080e7          	jalr	-396(ra) # 4c40 <printf>
    exit(1);
    3dd4:	4505                	li	a0,1
...
0000000000003dde <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    3e16:	e4e50513          	addi	a0,a0,-434 # 5c60 <malloc+0xf62>
    3e1a:	00001097          	auipc	ra,0x1
    3e1e:	e26080e7          	jalr	-474(ra) # 4c40 <printf>
    exit(1);
    3e22:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    3e6c:	df850513          	addi	a0,a0,-520 # 5c60 <malloc+0xf62>
    3e70:	00001097          	auipc	ra,0x1
    3e74:	dd0080e7          	jalr	-560(ra) # 4c40 <printf>
    exit(1);
    3e78:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    3ecc:	d9850513          	addi	a0,a0,-616 # 5c60 <malloc+0xf62>
    3ed0:	00001097          	auipc	ra,0x1
    3ed4:	d70080e7          	jalr	-656(ra) # 4c40 <printf>
    exit(1);
    3ed8:	4505                	li	a0,1
...
0000000000003ef6 <dirtest>:
{
  ...
  printf("mkdir test\n");
    ...
    3f06:	b4650513          	addi	a0,a0,-1210 # 6a48 <malloc+0x1d4a>
    3f0a:	00001097          	auipc	ra,0x1
    3f0e:	d36080e7          	jalr	-714(ra) # 4c40 <printf>
  if(mkdir("dir0") < 0){
    3f12:	00003517          	auipc	a0,0x3
    3f16:	b4650513          	addi	a0,a0,-1210 # 6a58 <malloc+0x1d5a>
  ...
  if(chdir("dir0") < 0){
    ...
    3f2a:	b3250513          	addi	a0,a0,-1230 # 6a58 <malloc+0x1d5a>
  ...
  if(chdir("..") < 0){
    ...
    3f3e:	ad650513          	addi	a0,a0,-1322 # 5a10 <malloc+0xd12>
  ...
  if(unlink("dir0") < 0){
    ...
    3f52:	b0a50513          	addi	a0,a0,-1270 # 6a58 <malloc+0x1d5a>
  ...
  printf("%s: mkdir test ok\n");
    ...
    3f66:	b4650513          	addi	a0,a0,-1210 # 6aa8 <malloc+0x1daa>
    3f6a:	00001097          	auipc	ra,0x1
    3f6e:	cd6080e7          	jalr	-810(ra) # 4c40 <printf>
}
    ...
    3f82:	99a50513          	addi	a0,a0,-1638 # 5918 <malloc+0xc1a>
    3f86:	00001097          	auipc	ra,0x1
    3f8a:	cba080e7          	jalr	-838(ra) # 4c40 <printf>
    exit(1);
    3f8e:	4505                	li	a0,1
    ...
    3f9e:	ac650513          	addi	a0,a0,-1338 # 6a60 <malloc+0x1d62>
    3fa2:	00001097          	auipc	ra,0x1
    3fa6:	c9e080e7          	jalr	-866(ra) # 4c40 <printf>
    exit(1);
    3faa:	4505                	li	a0,1
    ...
    3fba:	ac250513          	addi	a0,a0,-1342 # 6a78 <malloc+0x1d7a>
    3fbe:	00001097          	auipc	ra,0x1
    3fc2:	c82080e7          	jalr	-894(ra) # 4c40 <printf>
    exit(1);
    3fc6:	4505                	li	a0,1
    ...
    3fd6:	abe50513          	addi	a0,a0,-1346 # 6a90 <malloc+0x1d92>
    3fda:	00001097          	auipc	ra,0x1
    3fde:	c66080e7          	jalr	-922(ra) # 4c40 <printf>
    exit(1);
    3fe2:	4505                	li	a0,1
...
0000000000003fec <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4014:	cee080e7          	jalr	-786(ra) # 4cfe <malloc>
    ...
    4054:	a7050513          	addi	a0,a0,-1424 # 6ac0 <malloc+0x1dc2>
    4058:	00001097          	auipc	ra,0x1
    405c:	be8080e7          	jalr	-1048(ra) # 4c40 <printf>
      exit(1);
    4060:	4505                	li	a0,1
...
0000000000004082 <sbrkbasic>:
{
  ...
  if(a != (char*)0xffffffffffffffffL){
    ...
    40ae:	a3650513          	addi	a0,a0,-1482 # 6ae0 <malloc+0x1de2>
    40b2:	00001097          	auipc	ra,0x1
    40b6:	b8e080e7          	jalr	-1138(ra) # 4c40 <printf>
    exit(1);
    40ba:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    4128:	a2450513          	addi	a0,a0,-1500 # 6b48 <malloc+0x1e4a>
    412c:	00001097          	auipc	ra,0x1
    4130:	b14080e7          	jalr	-1260(ra) # 4c40 <printf>
    exit(1);
    4134:	4505                	li	a0,1
    ...
    414a:	9c250513          	addi	a0,a0,-1598 # 6b08 <malloc+0x1e0a>
    414e:	00001097          	auipc	ra,0x1
    4152:	af2080e7          	jalr	-1294(ra) # 4c40 <printf>
      exit(1);
    4156:	4505                	li	a0,1
    ...
    4166:	9c650513          	addi	a0,a0,-1594 # 6b28 <malloc+0x1e2a>
    416a:	00001097          	auipc	ra,0x1
    416e:	ad6080e7          	jalr	-1322(ra) # 4c40 <printf>
    exit(1);
    4172:	4505                	li	a0,1
...
00000000000041a2 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    41c4:	9a850513          	addi	a0,a0,-1624 # 6b68 <malloc+0x1e6a>
    41c8:	00001097          	auipc	ra,0x1
    41cc:	a78080e7          	jalr	-1416(ra) # 4c40 <printf>
  for(nfiles = 0; ; nfiles++){
    41d0:	4481                	li	s1,0
    name[0] = 'f';
    ...
    41e4:	998c8c93          	addi	s9,s9,-1640 # 6b78 <malloc+0x1e7a>
    int total = 0;
    41e8:	4d81                	li	s11,0
      int cc = write(fd, buf, BSIZE);
    41ea:	00005a17          	auipc	s4,0x5
    41ee:	63ea0a13          	addi	s4,s4,1598 # 9828 <buf>
    name[0] = 'f';
    ...
    423c:	a08080e7          	jalr	-1528(ra) # 4c40 <printf>
    ...
    425e:	92e50513          	addi	a0,a0,-1746 # 6b88 <malloc+0x1e8a>
    4262:	00001097          	auipc	ra,0x1
    4266:	9de080e7          	jalr	-1570(ra) # 4c40 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    42d4:	8e850513          	addi	a0,a0,-1816 # 6bb8 <malloc+0x1eba>
    42d8:	00001097          	auipc	ra,0x1
    42dc:	968080e7          	jalr	-1688(ra) # 4c40 <printf>
}
    ...
    4324:	88050513          	addi	a0,a0,-1920 # 6ba0 <malloc+0x1ea2>
    4328:	00001097          	auipc	ra,0x1
    432c:	918080e7          	jalr	-1768(ra) # 4c40 <printf>
    close(fd);
    4330:	854a                	mv	a0,s2
...
0000000000004342 <rand>:
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    434c:	cb870713          	addi	a4,a4,-840 # 7000 <randstate>
    4350:	6308                	ld	a0,0(a4)
    4352:	001967b7          	lui	a5,0x196
    4356:	60d78793          	addi	a5,a5,1549 # 19660d <__BSS_END__+0x189dd5>
    435a:	02f50533          	mul	a0,a0,a5
    435e:	3c6ef7b7          	lui	a5,0x3c6ef
    4362:	35f78793          	addi	a5,a5,863 # 3c6ef35f <__BSS_END__+0x3c6e2b27>
...
0000000000004372 <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    43e6:	7ee50513          	addi	a0,a0,2030 # 6bd0 <malloc+0x1ed2>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    43fe:	d4e58593          	addi	a1,a1,-690 # 5148 <malloc+0x44a>
    ...
    4414:	7e050513          	addi	a0,a0,2016 # 6bf0 <malloc+0x1ef2>
    4418:	00001097          	auipc	ra,0x1
    441c:	828080e7          	jalr	-2008(ra) # 4c40 <printf>
    exit(1);
    4420:	4505                	li	a0,1
    ...
    442e:	7ae50513          	addi	a0,a0,1966 # 6bd8 <malloc+0x1eda>
    4432:	00001097          	auipc	ra,0x1
    4436:	80e080e7          	jalr	-2034(ra) # 4c40 <printf>
      exit(1);
    443a:	4505                	li	a0,1
    ...
    4448:	79450513          	addi	a0,a0,1940 # 6bd8 <malloc+0x1eda>
    444c:	00000097          	auipc	ra,0x0
    4450:	7f4080e7          	jalr	2036(ra) # 4c40 <printf>
    exit(1);
    4454:	4505                	li	a0,1
  ...
  unlink("junk");
    ...
    446c:	76850513          	addi	a0,a0,1896 # 6bd0 <malloc+0x1ed2>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    4496:	76e50513          	addi	a0,a0,1902 # 6c00 <malloc+0x1f02>
    449a:	00000097          	auipc	ra,0x0
    449e:	7a6080e7          	jalr	1958(ra) # 4c40 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    44c8:	76450513          	addi	a0,a0,1892 # 6c28 <malloc+0x1f2a>
    44cc:	00000097          	auipc	ra,0x0
    44d0:	774080e7          	jalr	1908(ra) # 4c40 <printf>
    else
      printf("OK\n", s);
    return xstatus == 0;
    ...
    44ec:	72850513          	addi	a0,a0,1832 # 6c10 <malloc+0x1f12>
    44f0:	00000097          	auipc	ra,0x0
    44f4:	750080e7          	jalr	1872(ra) # 4c40 <printf>
    exit(1);
    44f8:	4505                	li	a0,1
    ...
    4516:	71e50513          	addi	a0,a0,1822 # 6c30 <malloc+0x1f32>
    451a:	00000097          	auipc	ra,0x0
    451e:	726080e7          	jalr	1830(ra) # 4c40 <printf>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    4552:	78a78793          	addi	a5,a5,1930 # 6cd8 <malloc+0x1fda>
    4556:	cd040713          	addi	a4,s0,-816
    455a:	00003817          	auipc	a6,0x3
    455e:	a7e80813          	addi	a6,a6,-1410 # 6fd8 <malloc+0x22da>
  ...
  printf("usertests starting\n");
    ...
    4582:	6ba50513          	addi	a0,a0,1722 # 6c38 <malloc+0x1f3a>
    4586:	00000097          	auipc	ra,0x0
    458a:	6ba080e7          	jalr	1722(ra) # 4c40 <printf>

  if(open("usertests.ran", 0) >= 0){
    458e:	4581                	li	a1,0
    4590:	00002517          	auipc	a0,0x2
    4594:	6c050513          	addi	a0,a0,1728 # 6c50 <malloc+0x1f52>
    ...
    45a8:	6bc50513          	addi	a0,a0,1724 # 6c60 <malloc+0x1f62>
    45ac:	00000097          	auipc	ra,0x0
    45b0:	694080e7          	jalr	1684(ra) # 4c40 <printf>
    exit(1);
    45b4:	4505                	li	a0,1
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    45c6:	68e50513          	addi	a0,a0,1678 # 6c50 <malloc+0x1f52>
  ...
  if(!fail)
    ...
    461a:	6aa50513          	addi	a0,a0,1706 # 6cc0 <malloc+0x1fc2>
    461e:	00000097          	auipc	ra,0x0
    4622:	622080e7          	jalr	1570(ra) # 4c40 <printf>
    4626:	a809                	j	4638 <main+0x114>
    printf("ALL TESTS PASSED\n");
    4628:	00002517          	auipc	a0,0x2
    462c:	68050513          	addi	a0,a0,1664 # 6ca8 <malloc+0x1faa>
    4630:	00000097          	auipc	ra,0x0
    4634:	610080e7          	jalr	1552(ra) # 4c40 <printf>
  exit(1);   // not reached.
    4638:	4505                	li	a0,1
...
putc(int fd, char c)
{
    4968:	1101                	addi	sp,sp,-32
    496a:	ec06                	sd	ra,24(sp)
    496c:	e822                	sd	s0,16(sp)
    496e:	1000                	addi	s0,sp,32
    4970:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    4974:	4605                	li	a2,1
    4976:	fef40593          	addi	a1,s0,-17
    497a:	00000097          	auipc	ra,0x0
    497e:	f5e080e7          	jalr	-162(ra) # 48d8 <write>
}
    4982:	60e2                	ld	ra,24(sp)
    4984:	6442                	ld	s0,16(sp)
    4986:	6105                	addi	sp,sp,32
    4988:	8082                	ret

000000000000498a <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
    498a:	7139                	addi	sp,sp,-64
    498c:	fc06                	sd	ra,56(sp)
    498e:	f822                	sd	s0,48(sp)
    4990:	f426                	sd	s1,40(sp)
    4992:	f04a                	sd	s2,32(sp)
    4994:	ec4e                	sd	s3,24(sp)
    4996:	0080                	addi	s0,sp,64
    4998:	84aa                	mv	s1,a0
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    499a:	c299                	beqz	a3,49a0 <printint+0x16>
    499c:	0805c863          	bltz	a1,4a2c <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    49a0:	2581                	sext.w	a1,a1
  neg = 0;
    49a2:	4881                	li	a7,0
    49a4:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    49aa:	2601                	sext.w	a2,a2
    49ac:	00002517          	auipc	a0,0x2
    49b0:	63450513          	addi	a0,a0,1588 # 6fe0 <digits>
    49b4:	883a                	mv	a6,a4
    49b6:	2705                	addiw	a4,a4,1
    49b8:	02c5f7bb          	remuw	a5,a1,a2
    49bc:	1782                	slli	a5,a5,0x20
    49be:	9381                	srli	a5,a5,0x20
    49c0:	97aa                	add	a5,a5,a0
    49c2:	0007c783          	lbu	a5,0(a5)
    49c6:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    49ca:	0005879b          	sext.w	a5,a1
    49ce:	02c5d5bb          	divuw	a1,a1,a2
    49d2:	0685                	addi	a3,a3,1
    49d4:	fec7f0e3          	bgeu	a5,a2,49b4 <printint+0x2a>
  if(neg)
    49d8:	00088b63          	beqz	a7,49ee <printint+0x64>
    buf[i++] = '-';
    49dc:	fd040793          	addi	a5,s0,-48
    49e0:	973e                	add	a4,a4,a5
    49e2:	02d00793          	li	a5,45
    49e6:	fef70823          	sb	a5,-16(a4)
    49ea:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    49ee:	02e05863          	blez	a4,4a1e <printint+0x94>
    49f2:	fc040793          	addi	a5,s0,-64
    49f6:	00e78933          	add	s2,a5,a4
    49fa:	fff78993          	addi	s3,a5,-1
    49fe:	99ba                	add	s3,s3,a4
    4a00:	377d                	addiw	a4,a4,-1
    4a02:	1702                	slli	a4,a4,0x20
    4a04:	9301                	srli	a4,a4,0x20
    4a06:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    4a0a:	fff94583          	lbu	a1,-1(s2)
    4a0e:	8526                	mv	a0,s1
    4a10:	00000097          	auipc	ra,0x0
    4a14:	f58080e7          	jalr	-168(ra) # 4968 <putc>
  while(--i >= 0)
    4a18:	197d                	addi	s2,s2,-1
    4a1a:	ff3918e3          	bne	s2,s3,4a0a <printint+0x80>
}
    4a1e:	70e2                	ld	ra,56(sp)
    4a20:	7442                	ld	s0,48(sp)
    4a22:	74a2                	ld	s1,40(sp)
    4a24:	7902                	ld	s2,32(sp)
    4a26:	69e2                	ld	s3,24(sp)
    4a28:	6121                	addi	sp,sp,64
    4a2a:	8082                	ret
    x = -xx;
    4a2c:	40b005bb          	negw	a1,a1
    neg = 1;
    4a30:	4885                	li	a7,1
    x = -xx;
    4a32:	bf8d                	j	49a4 <printint+0x1a>

0000000000004a34 <vprintf>:
}
...
{
    4a34:	7119                	addi	sp,sp,-128
    4a36:	fc86                	sd	ra,120(sp)
    4a38:	f8a2                	sd	s0,112(sp)
    4a3a:	f4a6                	sd	s1,104(sp)
    4a3c:	f0ca                	sd	s2,96(sp)
    4a3e:	ecce                	sd	s3,88(sp)
    4a40:	e8d2                	sd	s4,80(sp)
    4a42:	e4d6                	sd	s5,72(sp)
    4a44:	e0da                	sd	s6,64(sp)
    4a46:	fc5e                	sd	s7,56(sp)
    4a48:	f862                	sd	s8,48(sp)
    4a4a:	f466                	sd	s9,40(sp)
    4a4c:	f06a                	sd	s10,32(sp)
    4a4e:	ec6e                	sd	s11,24(sp)
    4a50:	0100                	addi	s0,sp,128
  char *s;
  int c, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    4a52:	0005c903          	lbu	s2,0(a1)
    4a56:	18090f63          	beqz	s2,4bf4 <vprintf+0x1c0>
    4a5a:	8aaa                	mv	s5,a0
    4a5c:	8b32                	mv	s6,a2
    4a5e:	00158493          	addi	s1,a1,1
  state = 0;
    4a62:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    4a64:	02500a13          	li	s4,37
      if(c == 'd'){
    4a68:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
    4a6c:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
    4a70:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
    4a74:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    4a78:	00002b97          	auipc	s7,0x2
    4a7c:	568b8b93          	addi	s7,s7,1384 # 6fe0 <digits>
    4a80:	a839                	j	4a9e <vprintf+0x6a>
        putc(fd, c);
    4a82:	85ca                	mv	a1,s2
    4a84:	8556                	mv	a0,s5
    4a86:	00000097          	auipc	ra,0x0
    4a8a:	ee2080e7          	jalr	-286(ra) # 4968 <putc>
    4a8e:	a019                	j	4a94 <vprintf+0x60>
    } else if(state == '%'){
    4a90:	01498f63          	beq	s3,s4,4aae <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
    4a94:	0485                	addi	s1,s1,1
    4a96:	fff4c903          	lbu	s2,-1(s1)
    4a9a:	14090d63          	beqz	s2,4bf4 <vprintf+0x1c0>
    c = fmt[i] & 0xff;
    4a9e:	0009079b          	sext.w	a5,s2
    if(state == 0){
    4aa2:	fe0997e3          	bnez	s3,4a90 <vprintf+0x5c>
      if(c == '%'){
    4aa6:	fd479ee3          	bne	a5,s4,4a82 <vprintf+0x4e>
        state = '%';
    4aaa:	89be                	mv	s3,a5
    4aac:	b7e5                	j	4a94 <vprintf+0x60>
      if(c == 'd'){
    4aae:	05878063          	beq	a5,s8,4aee <vprintf+0xba>
      } else if(c == 'l') {
    4ab2:	05978c63          	beq	a5,s9,4b0a <vprintf+0xd6>
      } else if(c == 'x') {
    4ab6:	07a78863          	beq	a5,s10,4b26 <vprintf+0xf2>
      } else if(c == 'p') {
    4aba:	09b78463          	beq	a5,s11,4b42 <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
    4abe:	07300713          	li	a4,115
    4ac2:	0ce78663          	beq	a5,a4,4b8e <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    4ac6:	06300713          	li	a4,99
    4aca:	0ee78e63          	beq	a5,a4,4bc6 <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    4ace:	11478863          	beq	a5,s4,4bde <vprintf+0x1aa>
        putc(fd, c);
      } else {
    ...
    4ad2:	85d2                	mv	a1,s4
    4ad4:	8556                	mv	a0,s5
    4ad6:	00000097          	auipc	ra,0x0
    4ada:	e92080e7          	jalr	-366(ra) # 4968 <putc>
        putc(fd, c);
    4ade:	85ca                	mv	a1,s2
    4ae0:	8556                	mv	a0,s5
    4ae2:	00000097          	auipc	ra,0x0
    4ae6:	e86080e7          	jalr	-378(ra) # 4968 <putc>
      }
      state = 0;
    4aea:	4981                	li	s3,0
    4aec:	b765                	j	4a94 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
    4aee:	008b0913          	addi	s2,s6,8
    4af2:	4685                	li	a3,1
    4af4:	4629                	li	a2,10
    4af6:	000b2583          	lw	a1,0(s6)
    4afa:	8556                	mv	a0,s5
    4afc:	00000097          	auipc	ra,0x0
    4b00:	e8e080e7          	jalr	-370(ra) # 498a <printint>
    4b04:	8b4a                	mv	s6,s2
      state = 0;
    4b06:	4981                	li	s3,0
    4b08:	b771                	j	4a94 <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    4b0a:	008b0913          	addi	s2,s6,8
    4b0e:	4681                	li	a3,0
    4b10:	4629                	li	a2,10
    4b12:	000b2583          	lw	a1,0(s6)
    4b16:	8556                	mv	a0,s5
    4b18:	00000097          	auipc	ra,0x0
    4b1c:	e72080e7          	jalr	-398(ra) # 498a <printint>
    4b20:	8b4a                	mv	s6,s2
      state = 0;
    4b22:	4981                	li	s3,0
    4b24:	bf85                	j	4a94 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    4b26:	008b0913          	addi	s2,s6,8
    4b2a:	4681                	li	a3,0
    4b2c:	4641                	li	a2,16
    4b2e:	000b2583          	lw	a1,0(s6)
    4b32:	8556                	mv	a0,s5
    4b34:	00000097          	auipc	ra,0x0
    4b38:	e56080e7          	jalr	-426(ra) # 498a <printint>
    4b3c:	8b4a                	mv	s6,s2
      state = 0;
    4b3e:	4981                	li	s3,0
    4b40:	bf91                	j	4a94 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    4b42:	008b0793          	addi	a5,s6,8
    4b46:	f8f43423          	sd	a5,-120(s0)
    4b4a:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    4b4e:	03000593          	li	a1,48
    4b52:	8556                	mv	a0,s5
    4b54:	00000097          	auipc	ra,0x0
    4b58:	e14080e7          	jalr	-492(ra) # 4968 <putc>
  putc(fd, 'x');
    4b5c:	85ea                	mv	a1,s10
    4b5e:	8556                	mv	a0,s5
    4b60:	00000097          	auipc	ra,0x0
    4b64:	e08080e7          	jalr	-504(ra) # 4968 <putc>
    4b68:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    4b6a:	03c9d793          	srli	a5,s3,0x3c
    4b6e:	97de                	add	a5,a5,s7
    4b70:	0007c583          	lbu	a1,0(a5)
    4b74:	8556                	mv	a0,s5
    4b76:	00000097          	auipc	ra,0x0
    4b7a:	df2080e7          	jalr	-526(ra) # 4968 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    4b7e:	0992                	slli	s3,s3,0x4
    4b80:	397d                	addiw	s2,s2,-1
    4b82:	fe0914e3          	bnez	s2,4b6a <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    4b86:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    4b8a:	4981                	li	s3,0
    4b8c:	b721                	j	4a94 <vprintf+0x60>
        s = va_arg(ap, char*);
    4b8e:	008b0993          	addi	s3,s6,8
    4b92:	000b3903          	ld	s2,0(s6)
        if(s == 0)
    4b96:	02090163          	beqz	s2,4bb8 <vprintf+0x184>
        while(*s != 0){
    4b9a:	00094583          	lbu	a1,0(s2)
    4b9e:	c9a1                	beqz	a1,4bee <vprintf+0x1ba>
          putc(fd, *s);
    4ba0:	8556                	mv	a0,s5
    4ba2:	00000097          	auipc	ra,0x0
    4ba6:	dc6080e7          	jalr	-570(ra) # 4968 <putc>
          s++;
    4baa:	0905                	addi	s2,s2,1
        while(*s != 0){
    4bac:	00094583          	lbu	a1,0(s2)
    4bb0:	f9e5                	bnez	a1,4ba0 <vprintf+0x16c>
        s = va_arg(ap, char*);
    4bb2:	8b4e                	mv	s6,s3
      state = 0;
    4bb4:	4981                	li	s3,0
    4bb6:	bdf9                	j	4a94 <vprintf+0x60>
          s = "(null)";
    4bb8:	00002917          	auipc	s2,0x2
    4bbc:	42090913          	addi	s2,s2,1056 # 6fd8 <malloc+0x22da>
        while(*s != 0){
    4bc0:	02800593          	li	a1,40
    4bc4:	bff1                	j	4ba0 <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
    4bc6:	008b0913          	addi	s2,s6,8
    4bca:	000b4583          	lbu	a1,0(s6)
    4bce:	8556                	mv	a0,s5
    4bd0:	00000097          	auipc	ra,0x0
    4bd4:	d98080e7          	jalr	-616(ra) # 4968 <putc>
    4bd8:	8b4a                	mv	s6,s2
      state = 0;
    4bda:	4981                	li	s3,0
    4bdc:	bd65                	j	4a94 <vprintf+0x60>
        putc(fd, c);
    4bde:	85d2                	mv	a1,s4
    4be0:	8556                	mv	a0,s5
    4be2:	00000097          	auipc	ra,0x0
    4be6:	d86080e7          	jalr	-634(ra) # 4968 <putc>
      state = 0;
    4bea:	4981                	li	s3,0
    4bec:	b565                	j	4a94 <vprintf+0x60>
        s = va_arg(ap, char*);
    4bee:	8b4e                	mv	s6,s3
      state = 0;
    4bf0:	4981                	li	s3,0
    4bf2:	b54d                	j	4a94 <vprintf+0x60>
    }
  }
}
    4bf4:	70e6                	ld	ra,120(sp)
    4bf6:	7446                	ld	s0,112(sp)
    4bf8:	74a6                	ld	s1,104(sp)
    4bfa:	7906                	ld	s2,96(sp)
    4bfc:	69e6                	ld	s3,88(sp)
    4bfe:	6a46                	ld	s4,80(sp)
    4c00:	6aa6                	ld	s5,72(sp)
    4c02:	6b06                	ld	s6,64(sp)
    4c04:	7be2                	ld	s7,56(sp)
    4c06:	7c42                	ld	s8,48(sp)
    4c08:	7ca2                	ld	s9,40(sp)
    4c0a:	7d02                	ld	s10,32(sp)
    4c0c:	6de2                	ld	s11,24(sp)
    4c0e:	6109                	addi	sp,sp,128
    4c10:	8082                	ret

0000000000004c12 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    4c12:	715d                	addi	sp,sp,-80
    4c14:	ec06                	sd	ra,24(sp)
    4c16:	e822                	sd	s0,16(sp)
    4c18:	1000                	addi	s0,sp,32
    4c1a:	e010                	sd	a2,0(s0)
    4c1c:	e414                	sd	a3,8(s0)
    4c1e:	e818                	sd	a4,16(s0)
    4c20:	ec1c                	sd	a5,24(s0)
    4c22:	03043023          	sd	a6,32(s0)
    4c26:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    4c2a:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    4c2e:	8622                	mv	a2,s0
    4c30:	00000097          	auipc	ra,0x0
    4c34:	e04080e7          	jalr	-508(ra) # 4a34 <vprintf>
}
    4c38:	60e2                	ld	ra,24(sp)
    4c3a:	6442                	ld	s0,16(sp)
    4c3c:	6161                	addi	sp,sp,80
    4c3e:	8082                	ret

0000000000004c40 <printf>:

void
printf(const char *fmt, ...)
{
    4c40:	711d                	addi	sp,sp,-96
    4c42:	ec06                	sd	ra,24(sp)
    4c44:	e822                	sd	s0,16(sp)
    4c46:	1000                	addi	s0,sp,32
    4c48:	e40c                	sd	a1,8(s0)
    4c4a:	e810                	sd	a2,16(s0)
    4c4c:	ec14                	sd	a3,24(s0)
    4c4e:	f018                	sd	a4,32(s0)
    4c50:	f41c                	sd	a5,40(s0)
    4c52:	03043823          	sd	a6,48(s0)
    4c56:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    4c5a:	00840613          	addi	a2,s0,8
    4c5e:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    4c62:	85aa                	mv	a1,a0
    4c64:	4505                	li	a0,1
    4c66:	00000097          	auipc	ra,0x0
    4c6a:	dce080e7          	jalr	-562(ra) # 4a34 <vprintf>
}
    4c6e:	60e2                	ld	ra,24(sp)
    4c70:	6442                	ld	s0,16(sp)
    4c72:	6125                	addi	sp,sp,96
    4c74:	8082                	ret

0000000000004c76 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    ...
    4c78:	e422                	sd	s0,8(sp)
    4c7a:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    4c7c:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4c80:	00002797          	auipc	a5,0x2
    4c84:	3907b783          	ld	a5,912(a5) # 7010 <freep>
    4c88:	a805                	j	4cb8 <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    4c8a:	4618                	lw	a4,8(a2)
    4c8c:	9db9                	addw	a1,a1,a4
    4c8e:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    4c92:	6398                	ld	a4,0(a5)
    4c94:	6318                	ld	a4,0(a4)
    4c96:	fee53823          	sd	a4,-16(a0)
    4c9a:	a091                	j	4cde <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    4c9c:	ff852703          	lw	a4,-8(a0)
    4ca0:	9e39                	addw	a2,a2,a4
    4ca2:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    4ca4:	ff053703          	ld	a4,-16(a0)
    4ca8:	e398                	sd	a4,0(a5)
    4caa:	a099                	j	4cf0 <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    4cac:	6398                	ld	a4,0(a5)
    4cae:	00e7e463          	bltu	a5,a4,4cb6 <free+0x40>
    4cb2:	00e6ea63          	bltu	a3,a4,4cc6 <free+0x50>
{
    4cb6:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4cb8:	fed7fae3          	bgeu	a5,a3,4cac <free+0x36>
    4cbc:	6398                	ld	a4,0(a5)
    4cbe:	00e6e463          	bltu	a3,a4,4cc6 <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    4cc2:	fee7eae3          	bltu	a5,a4,4cb6 <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    4cc6:	ff852583          	lw	a1,-8(a0)
    4cca:	6390                	ld	a2,0(a5)
    4ccc:	02059713          	slli	a4,a1,0x20
    4cd0:	9301                	srli	a4,a4,0x20
    4cd2:	0712                	slli	a4,a4,0x4
    4cd4:	9736                	add	a4,a4,a3
    4cd6:	fae60ae3          	beq	a2,a4,4c8a <free+0x14>
    bp->s.ptr = p->s.ptr;
    4cda:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    4cde:	4790                	lw	a2,8(a5)
    4ce0:	02061713          	slli	a4,a2,0x20
    4ce4:	9301                	srli	a4,a4,0x20
    4ce6:	0712                	slli	a4,a4,0x4
    4ce8:	973e                	add	a4,a4,a5
    4cea:	fae689e3          	beq	a3,a4,4c9c <free+0x26>
  } else
    p->s.ptr = bp;
    4cee:	e394                	sd	a3,0(a5)
  freep = p;
    4cf0:	00002717          	auipc	a4,0x2
    4cf4:	32f73023          	sd	a5,800(a4) # 7010 <freep>
}
    4cf8:	6422                	ld	s0,8(sp)
    4cfa:	0141                	addi	sp,sp,16
    4cfc:	8082                	ret

0000000000004cfe <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    4cfe:	7139                	addi	sp,sp,-64
    4d00:	fc06                	sd	ra,56(sp)
    4d02:	f822                	sd	s0,48(sp)
    4d04:	f426                	sd	s1,40(sp)
    4d06:	f04a                	sd	s2,32(sp)
    4d08:	ec4e                	sd	s3,24(sp)
    4d0a:	e852                	sd	s4,16(sp)
    4d0c:	e456                	sd	s5,8(sp)
    4d0e:	e05a                	sd	s6,0(sp)
    4d10:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    4d12:	02051493          	slli	s1,a0,0x20
    4d16:	9081                	srli	s1,s1,0x20
    4d18:	04bd                	addi	s1,s1,15
    4d1a:	8091                	srli	s1,s1,0x4
    4d1c:	0014899b          	addiw	s3,s1,1
    4d20:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    4d22:	00002517          	auipc	a0,0x2
    4d26:	2ee53503          	ld	a0,750(a0) # 7010 <freep>
    4d2a:	c515                	beqz	a0,4d56 <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    4d2c:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    4d2e:	4798                	lw	a4,8(a5)
    4d30:	02977f63          	bgeu	a4,s1,4d6e <malloc+0x70>
    4d34:	8a4e                	mv	s4,s3
    4d36:	0009871b          	sext.w	a4,s3
    4d3a:	6685                	lui	a3,0x1
    4d3c:	00d77363          	bgeu	a4,a3,4d42 <malloc+0x44>
    4d40:	6a05                	lui	s4,0x1
    4d42:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    4d46:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    4d4a:	00002917          	auipc	s2,0x2
    4d4e:	2c690913          	addi	s2,s2,710 # 7010 <freep>
  if(p == (char*)-1)
    4d52:	5afd                	li	s5,-1
    4d54:	a88d                	j	4dc6 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    4d56:	00008797          	auipc	a5,0x8
    4d5a:	ad278793          	addi	a5,a5,-1326 # c828 <base>
    4d5e:	00002717          	auipc	a4,0x2
    4d62:	2af73923          	sd	a5,690(a4) # 7010 <freep>
    4d66:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    4d68:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    4d6c:	b7e1                	j	4d34 <malloc+0x36>
      if(p->s.size == nunits)
    4d6e:	02e48b63          	beq	s1,a4,4da4 <malloc+0xa6>
        p->s.size -= nunits;
    4d72:	4137073b          	subw	a4,a4,s3
    4d76:	c798                	sw	a4,8(a5)
        p += p->s.size;
    4d78:	1702                	slli	a4,a4,0x20
    4d7a:	9301                	srli	a4,a4,0x20
    4d7c:	0712                	slli	a4,a4,0x4
    4d7e:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    4d80:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    4d84:	00002717          	auipc	a4,0x2
    4d88:	28a73623          	sd	a0,652(a4) # 7010 <freep>
      return (void*)(p + 1);
    4d8c:	01078513          	addi	a0,a5,16
      if((p = morecore(nunits)) == 0)
        return 0;
  }
}
    4d90:	70e2                	ld	ra,56(sp)
    4d92:	7442                	ld	s0,48(sp)
    4d94:	74a2                	ld	s1,40(sp)
    4d96:	7902                	ld	s2,32(sp)
    4d98:	69e2                	ld	s3,24(sp)
    4d9a:	6a42                	ld	s4,16(sp)
    4d9c:	6aa2                	ld	s5,8(sp)
    4d9e:	6b02                	ld	s6,0(sp)
    4da0:	6121                	addi	sp,sp,64
    4da2:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    4da4:	6398                	ld	a4,0(a5)
    4da6:	e118                	sd	a4,0(a0)
    4da8:	bff1                	j	4d84 <malloc+0x86>
  hp->s.size = nu;
    4daa:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    4dae:	0541                	addi	a0,a0,16
    4db0:	00000097          	auipc	ra,0x0
    4db4:	ec6080e7          	jalr	-314(ra) # 4c76 <free>
  return freep;
    4db8:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    4dbc:	d971                	beqz	a0,4d90 <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    4dbe:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    4dc0:	4798                	lw	a4,8(a5)
    4dc2:	fa9776e3          	bgeu	a4,s1,4d6e <malloc+0x70>
    if(p == freep)
    4dc6:	00093703          	ld	a4,0(s2)
    4dca:	853e                	mv	a0,a5
    4dcc:	fef719e3          	bne	a4,a5,4dbe <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
    4dd0:	8552                	mv	a0,s4
    4dd2:	00000097          	auipc	ra,0x0
    4dd6:	b6e080e7          	jalr	-1170(ra) # 4940 <sbrk>
  if(p == (char*)-1)
    4dda:	fd5518e3          	bne	a0,s5,4daa <malloc+0xac>
        return 0;
    4dde:	4501                	li	a0,0
    4de0:	bf45                	j	4d90 <malloc+0x92>
