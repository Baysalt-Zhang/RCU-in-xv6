...
simpletest()
{
  ...
  12:	c9250513          	addi	a0,a0,-878 # ca0 <malloc+0xe8>
  16:	00001097          	auipc	ra,0x1
  1a:	ae4080e7          	jalr	-1308(ra) # afa <printf>
  
  char *p = sbrk(sz);
  1e:	05555537          	lui	a0,0x5555
  22:	55450513          	addi	a0,a0,1364 # 5555554 <__BSS_END__+0x5550744>
  ...
  6a:	aac50513          	addi	a0,a0,-1364 # fffffffffaaaaaac <__BSS_END__+0xfffffffffaaa5c9c>
  ...
  80:	c7450513          	addi	a0,a0,-908 # cf0 <malloc+0x138>
  84:	00001097          	auipc	ra,0x1
  88:	a76080e7          	jalr	-1418(ra) # afa <printf>
}
  8c:	70a2                	ld	ra,40(sp)
  8e:	7402                	ld	s0,32(sp)
  90:	64e2                	ld	s1,24(sp)
  ...
  9e:	55458593          	addi	a1,a1,1364 # 5555554 <__BSS_END__+0x5550744>
  a2:	00001517          	auipc	a0,0x1
  a6:	c0e50513          	addi	a0,a0,-1010 # cb0 <malloc+0xf8>
  aa:	00001097          	auipc	ra,0x1
  ae:	a50080e7          	jalr	-1456(ra) # afa <printf>
    exit(-1);
  b2:	557d                	li	a0,-1
  ...
  c0:	c0c50513          	addi	a0,a0,-1012 # cc8 <malloc+0x110>
  c4:	00001097          	auipc	ra,0x1
  c8:	a36080e7          	jalr	-1482(ra) # afa <printf>
    exit(-1);
  cc:	557d                	li	a0,-1
  ...
  e2:	55458593          	addi	a1,a1,1364 # 5555554 <__BSS_END__+0x5550744>
  e6:	00001517          	auipc	a0,0x1
  ea:	bf250513          	addi	a0,a0,-1038 # cd8 <malloc+0x120>
  ee:	00001097          	auipc	ra,0x1
  f2:	a0c080e7          	jalr	-1524(ra) # afa <printf>
    exit(-1);
  f6:	557d                	li	a0,-1
...
threetest()
{
 ...
 114:	be850513          	addi	a0,a0,-1048 # cf8 <malloc+0x140>
 118:	00001097          	auipc	ra,0x1
 11c:	9e2080e7          	jalr	-1566(ra) # afa <printf>
 ...
 1a0:	b5450513          	addi	a0,a0,-1196 # cf0 <malloc+0x138>
 1a4:	00001097          	auipc	ra,0x1
 1a8:	956080e7          	jalr	-1706(ra) # afa <printf>
}
 ...
 1c4:	af050513          	addi	a0,a0,-1296 # cb0 <malloc+0xf8>
 1c8:	00001097          	auipc	ra,0x1
 1cc:	932080e7          	jalr	-1742(ra) # afa <printf>
    exit(-1);
 1d0:	557d                	li	a0,-1
 ...
 1de:	b2650513          	addi	a0,a0,-1242 # d00 <malloc+0x148>
 1e2:	00001097          	auipc	ra,0x1
 1e6:	918080e7          	jalr	-1768(ra) # afa <printf>
    exit(-1);
 1ea:	557d                	li	a0,-1
 ...
 244:	ad050513          	addi	a0,a0,-1328 # d10 <malloc+0x158>
 248:	00001097          	auipc	ra,0x1
 24c:	8b2080e7          	jalr	-1870(ra) # afa <printf>
      exit(-1);
 250:	557d                	li	a0,-1
 ...
 27e:	aa650513          	addi	a0,a0,-1370 # d20 <malloc+0x168>
 282:	00001097          	auipc	ra,0x1
 286:	878080e7          	jalr	-1928(ra) # afa <printf>
          exit(-1);
 28a:	557d                	li	a0,-1
 ...
 298:	a8c50513          	addi	a0,a0,-1396 # d20 <malloc+0x168>
 29c:	00001097          	auipc	ra,0x1
 2a0:	85e080e7          	jalr	-1954(ra) # afa <printf>
      exit(-1);
 2a4:	557d                	li	a0,-1
 ...
 2b6:	a2650513          	addi	a0,a0,-1498 # cd8 <malloc+0x120>
 2ba:	00001097          	auipc	ra,0x1
 2be:	840080e7          	jalr	-1984(ra) # afa <printf>
    exit(-1);
 2c2:	557d                	li	a0,-1
...
filetest()
{
 ...
 2dc:	a5850513          	addi	a0,a0,-1448 # d30 <malloc+0x178>
 2e0:	00001097          	auipc	ra,0x1
 2e4:	81a080e7          	jalr	-2022(ra) # afa <printf>
 ...
 2fc:	af848493          	addi	s1,s1,-1288 # df0 <fds>
  for(int i = 0; i < 4; i++){
 300:	490d                	li	s2,3
    if(pipe(fds) != 0){
 302:	8526                	mv	a0,s1
 ...
 376:	97e50513          	addi	a0,a0,-1666 # cf0 <malloc+0x138>
 37a:	00000097          	auipc	ra,0x0
 37e:	780080e7          	jalr	1920(ra) # afa <printf>
}
 ...
 392:	9aa50513          	addi	a0,a0,-1622 # d38 <malloc+0x180>
 396:	00000097          	auipc	ra,0x0
 39a:	764080e7          	jalr	1892(ra) # afa <printf>
      exit(-1);
 39e:	557d                	li	a0,-1
 ...
 3ac:	95850513          	addi	a0,a0,-1704 # d00 <malloc+0x148>
 3b0:	00000097          	auipc	ra,0x0
 3b4:	74a080e7          	jalr	1866(ra) # afa <printf>
      exit(-1);
 3b8:	557d                	li	a0,-1
 ...
 3d2:	a3258593          	addi	a1,a1,-1486 # 1e00 <buf>
 ...
 40a:	95a50513          	addi	a0,a0,-1702 # d60 <malloc+0x1a8>
 40e:	00000097          	auipc	ra,0x0
 412:	6ec080e7          	jalr	1772(ra) # afa <printf>
        exit(1);
 416:	4505                	li	a0,1
 ...
 424:	92850513          	addi	a0,a0,-1752 # d48 <malloc+0x190>
 428:	00000097          	auipc	ra,0x0
 42c:	6d2080e7          	jalr	1746(ra) # afa <printf>
        exit(1);
 430:	4505                	li	a0,1
 ...
 448:	93c50513          	addi	a0,a0,-1732 # d80 <malloc+0x1c8>
 44c:	00000097          	auipc	ra,0x0
 450:	6ae080e7          	jalr	1710(ra) # afa <printf>
      exit(-1);
 454:	557d                	li	a0,-1
 ...
 46c:	93050513          	addi	a0,a0,-1744 # d98 <malloc+0x1e0>
 470:	00000097          	auipc	ra,0x0
 474:	68a080e7          	jalr	1674(ra) # afa <printf>
    exit(1);
 478:	4505                	li	a0,1
...
main(int argc, char *argv[])
{
 ...
 4be:	8fe50513          	addi	a0,a0,-1794 # db8 <malloc+0x200>
 4c2:	00000097          	auipc	ra,0x0
 4c6:	638080e7          	jalr	1592(ra) # afa <printf>
...
gets(char *buf, int max)
{
 ...
 5e8:	00098023          	sb	zero,0(s3) # 199a000 <__BSS_END__+0x19951f0>
  return buf;
}
 5ec:	855e                	mv	a0,s7
...
atoi(const char *s)
{
 ...
 676:	fd07851b          	addiw	a0,a5,-48
  while('0' <= *s && *s <= '9')
 67a:	0006c603          	lbu	a2,0(a3) # 1000 <junk3+0x200>
...
0000000000000802 <rcu_read_only>:
...
000000000000080a <rcu_read_heavy>:
...
0000000000000812 <rcu_read_write_mix>:
...
000000000000081a <rcu_read_stress>:
...
putc(int fd, char c)
{
 ...
 838:	f36080e7          	jalr	-202(ra) # 76a <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 856:	0805c863          	bltz	a1,8e6 <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
 ...
 86a:	57250513          	addi	a0,a0,1394 # dd8 <digits>
 86e:	883a                	mv	a6,a4
 ...
 88e:	fec7f0e3          	bgeu	a5,a2,86e <printint+0x2a>
  if(neg)
 892:	00088b63          	beqz	a7,8a8 <printint+0x64>
    buf[i++] = '-';
 896:	fd040793          	addi	a5,s0,-48
 89a:	973e                	add	a4,a4,a5
 89c:	02d00793          	li	a5,45
 8a0:	fef70823          	sb	a5,-16(a4)
 8a4:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
 8a8:	02e05863          	blez	a4,8d8 <printint+0x94>
 8ac:	fc040793          	addi	a5,s0,-64
 8b0:	00e78933          	add	s2,a5,a4
 8b4:	fff78993          	addi	s3,a5,-1
 8b8:	99ba                	add	s3,s3,a4
 8ba:	377d                	addiw	a4,a4,-1
 8bc:	1702                	slli	a4,a4,0x20
 8be:	9301                	srli	a4,a4,0x20
 8c0:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
 8c4:	fff94583          	lbu	a1,-1(s2)
 8c8:	8526                	mv	a0,s1
 8ca:	00000097          	auipc	ra,0x0
 8ce:	f58080e7          	jalr	-168(ra) # 822 <putc>
  while(--i >= 0)
 8d2:	197d                	addi	s2,s2,-1
 8d4:	ff3918e3          	bne	s2,s3,8c4 <printint+0x80>
}
 ...
 8e4:	8082                	ret
    x = -xx;
 8e6:	40b005bb          	negw	a1,a1
    neg = 1;
 8ea:	4885                	li	a7,1
    x = -xx;
 8ec:	bf8d                	j	85e <printint+0x1a>

00000000000008ee <vprintf>:
}
...
{
 8ee:	7119                	addi	sp,sp,-128
 8f0:	fc86                	sd	ra,120(sp)
 8f2:	f8a2                	sd	s0,112(sp)
 8f4:	f4a6                	sd	s1,104(sp)
 8f6:	f0ca                	sd	s2,96(sp)
 8f8:	ecce                	sd	s3,88(sp)
 8fa:	e8d2                	sd	s4,80(sp)
 8fc:	e4d6                	sd	s5,72(sp)
 8fe:	e0da                	sd	s6,64(sp)
 900:	fc5e                	sd	s7,56(sp)
 902:	f862                	sd	s8,48(sp)
 904:	f466                	sd	s9,40(sp)
 906:	f06a                	sd	s10,32(sp)
 908:	ec6e                	sd	s11,24(sp)
 ...
 910:	18090f63          	beqz	s2,aae <vprintf+0x1c0>
 914:	8aaa                	mv	s5,a0
 916:	8b32                	mv	s6,a2
 918:	00158493          	addi	s1,a1,1
  state = 0;
 91c:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
 ...
 91e:	02500a13          	li	s4,37
      if(c == 'd'){
 922:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
 926:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
 92a:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
 92e:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 932:	00000b97          	auipc	s7,0x0
 936:	4a6b8b93          	addi	s7,s7,1190 # dd8 <digits>
 93a:	a839                	j	958 <vprintf+0x6a>
        putc(fd, c);
 93c:	85ca                	mv	a1,s2
 93e:	8556                	mv	a0,s5
 940:	00000097          	auipc	ra,0x0
 944:	ee2080e7          	jalr	-286(ra) # 822 <putc>
 948:	a019                	j	94e <vprintf+0x60>
    } else if(state == '%'){
 94a:	01498f63          	beq	s3,s4,968 <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
 94e:	0485                	addi	s1,s1,1
 950:	fff4c903          	lbu	s2,-1(s1)
 954:	14090d63          	beqz	s2,aae <vprintf+0x1c0>
    c = fmt[i] & 0xff;
 958:	0009079b          	sext.w	a5,s2
    if(state == 0){
 95c:	fe0997e3          	bnez	s3,94a <vprintf+0x5c>
      if(c == '%'){
 960:	fd479ee3          	bne	a5,s4,93c <vprintf+0x4e>
        state = '%';
 964:	89be                	mv	s3,a5
 966:	b7e5                	j	94e <vprintf+0x60>
      if(c == 'd'){
 968:	05878063          	beq	a5,s8,9a8 <vprintf+0xba>
      } else if(c == 'l') {
 96c:	05978c63          	beq	a5,s9,9c4 <vprintf+0xd6>
      } else if(c == 'x') {
 970:	07a78863          	beq	a5,s10,9e0 <vprintf+0xf2>
      } else if(c == 'p') {
 974:	09b78463          	beq	a5,s11,9fc <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
 978:	07300713          	li	a4,115
 97c:	0ce78663          	beq	a5,a4,a48 <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
 ...
 980:	06300713          	li	a4,99
 984:	0ee78e63          	beq	a5,a4,a80 <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
 988:	11478863          	beq	a5,s4,a98 <vprintf+0x1aa>
        putc(fd, c);
      } else {
 ...
 994:	e92080e7          	jalr	-366(ra) # 822 <putc>
        putc(fd, c);
 998:	85ca                	mv	a1,s2
 99a:	8556                	mv	a0,s5
 99c:	00000097          	auipc	ra,0x0
 9a0:	e86080e7          	jalr	-378(ra) # 822 <putc>
      }
      state = 0;
 9a4:	4981                	li	s3,0
 9a6:	b765                	j	94e <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
 ...
 9ba:	e8e080e7          	jalr	-370(ra) # 844 <printint>
 9be:	8b4a                	mv	s6,s2
      state = 0;
 9c0:	4981                	li	s3,0
 9c2:	b771                	j	94e <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
 9c4:	008b0913          	addi	s2,s6,8
 9c8:	4681                	li	a3,0
 9ca:	4629                	li	a2,10
 9cc:	000b2583          	lw	a1,0(s6)
 9d0:	8556                	mv	a0,s5
 9d2:	00000097          	auipc	ra,0x0
 9d6:	e72080e7          	jalr	-398(ra) # 844 <printint>
 9da:	8b4a                	mv	s6,s2
      state = 0;
 9dc:	4981                	li	s3,0
 9de:	bf85                	j	94e <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
 ...
 9f2:	e56080e7          	jalr	-426(ra) # 844 <printint>
 9f6:	8b4a                	mv	s6,s2
      state = 0;
 9f8:	4981                	li	s3,0
 9fa:	bf91                	j	94e <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
 9fc:	008b0793          	addi	a5,s6,8
 a00:	f8f43423          	sd	a5,-120(s0)
 a04:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
 a08:	03000593          	li	a1,48
 a0c:	8556                	mv	a0,s5
 a0e:	00000097          	auipc	ra,0x0
 a12:	e14080e7          	jalr	-492(ra) # 822 <putc>
  putc(fd, 'x');
 a16:	85ea                	mv	a1,s10
 a18:	8556                	mv	a0,s5
 a1a:	00000097          	auipc	ra,0x0
 a1e:	e08080e7          	jalr	-504(ra) # 822 <putc>
 a22:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 ...
 a34:	df2080e7          	jalr	-526(ra) # 822 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
 a38:	0992                	slli	s3,s3,0x4
 a3a:	397d                	addiw	s2,s2,-1
 a3c:	fe0914e3          	bnez	s2,a24 <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
 a40:	f8843b03          	ld	s6,-120(s0)
      state = 0;
 a44:	4981                	li	s3,0
 a46:	b721                	j	94e <vprintf+0x60>
        s = va_arg(ap, char*);
 a48:	008b0993          	addi	s3,s6,8
 a4c:	000b3903          	ld	s2,0(s6)
        if(s == 0)
 a50:	02090163          	beqz	s2,a72 <vprintf+0x184>
        while(*s != 0){
 a54:	00094583          	lbu	a1,0(s2)
 a58:	c9a1                	beqz	a1,aa8 <vprintf+0x1ba>
          putc(fd, *s);
 a5a:	8556                	mv	a0,s5
 a5c:	00000097          	auipc	ra,0x0
 a60:	dc6080e7          	jalr	-570(ra) # 822 <putc>
          s++;
 a64:	0905                	addi	s2,s2,1
        while(*s != 0){
 a66:	00094583          	lbu	a1,0(s2)
 a6a:	f9e5                	bnez	a1,a5a <vprintf+0x16c>
        s = va_arg(ap, char*);
 a6c:	8b4e                	mv	s6,s3
      state = 0;
 a6e:	4981                	li	s3,0
 a70:	bdf9                	j	94e <vprintf+0x60>
          s = "(null)";
 a72:	00000917          	auipc	s2,0x0
 a76:	35e90913          	addi	s2,s2,862 # dd0 <malloc+0x218>
        while(*s != 0){
 a7a:	02800593          	li	a1,40
 a7e:	bff1                	j	a5a <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
 a80:	008b0913          	addi	s2,s6,8
 a84:	000b4583          	lbu	a1,0(s6)
 a88:	8556                	mv	a0,s5
 a8a:	00000097          	auipc	ra,0x0
 a8e:	d98080e7          	jalr	-616(ra) # 822 <putc>
 a92:	8b4a                	mv	s6,s2
      state = 0;
 a94:	4981                	li	s3,0
 a96:	bd65                	j	94e <vprintf+0x60>
        putc(fd, c);
 a98:	85d2                	mv	a1,s4
 a9a:	8556                	mv	a0,s5
 a9c:	00000097          	auipc	ra,0x0
 aa0:	d86080e7          	jalr	-634(ra) # 822 <putc>
      state = 0;
 aa4:	4981                	li	s3,0
 aa6:	b565                	j	94e <vprintf+0x60>
        s = va_arg(ap, char*);
 aa8:	8b4e                	mv	s6,s3
      state = 0;
 aaa:	4981                	li	s3,0
 aac:	b54d                	j	94e <vprintf+0x60>
    }
  }
}
 aae:	70e6                	ld	ra,120(sp)
 ab0:	7446                	ld	s0,112(sp)
 ab2:	74a6                	ld	s1,104(sp)
 ab4:	7906                	ld	s2,96(sp)
 ab6:	69e6                	ld	s3,88(sp)
 ab8:	6a46                	ld	s4,80(sp)
 aba:	6aa6                	ld	s5,72(sp)
 abc:	6b06                	ld	s6,64(sp)
 abe:	7be2                	ld	s7,56(sp)
 ac0:	7c42                	ld	s8,48(sp)
 ac2:	7ca2                	ld	s9,40(sp)
 ac4:	7d02                	ld	s10,32(sp)
 ac6:	6de2                	ld	s11,24(sp)
 ac8:	6109                	addi	sp,sp,128
 aca:	8082                	ret

0000000000000acc <fprintf>:
...
fprintf(int fd, const char *fmt, ...)
{
 ...
 ad4:	e010                	sd	a2,0(s0)
 ad6:	e414                	sd	a3,8(s0)
 ad8:	e818                	sd	a4,16(s0)
 ada:	ec1c                	sd	a5,24(s0)
 ...
 aee:	e04080e7          	jalr	-508(ra) # 8ee <vprintf>
}
...
0000000000000afa <printf>:

void
printf(const char *fmt, ...)
{
 afa:	711d                	addi	sp,sp,-96
 ...
 b10:	03143c23          	sd	a7,56(s0)
  ...
  va_start(ap, fmt);
 b14:	00840613          	addi	a2,s0,8
 b18:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
 b1c:	85aa                	mv	a1,a0
 b1e:	4505                	li	a0,1
 b20:	00000097          	auipc	ra,0x0
 b24:	dce080e7          	jalr	-562(ra) # 8ee <vprintf>
}
 b28:	60e2                	ld	ra,24(sp)
 b2a:	6442                	ld	s0,16(sp)
 b2c:	6125                	addi	sp,sp,96
 b2e:	8082                	ret
...
free(void *ap)
{
 ...
 b34:	0800                	addi	s0,sp,16
  ...
  bp = (Header*)ap - 1;
 b36:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 b3a:	00000797          	auipc	a5,0x0
 b3e:	2be7b783          	ld	a5,702(a5) # df8 <freep>
 b42:	a805                	j	b72 <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
 b44:	4618                	lw	a4,8(a2)
 b46:	9db9                	addw	a1,a1,a4
 b48:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
 b4c:	6398                	ld	a4,0(a5)
 b4e:	6318                	ld	a4,0(a4)
 b50:	fee53823          	sd	a4,-16(a0)
 b54:	a091                	j	b98 <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
 b56:	ff852703          	lw	a4,-8(a0)
 b5a:	9e39                	addw	a2,a2,a4
 b5c:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
 b5e:	ff053703          	ld	a4,-16(a0)
 b62:	e398                	sd	a4,0(a5)
 b64:	a099                	j	baa <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 b66:	6398                	ld	a4,0(a5)
 b68:	00e7e463          	bltu	a5,a4,b70 <free+0x40>
 b6c:	00e6ea63          	bltu	a3,a4,b80 <free+0x50>
{
 b70:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 b72:	fed7fae3          	bgeu	a5,a3,b66 <free+0x36>
 b76:	6398                	ld	a4,0(a5)
 b78:	00e6e463          	bltu	a3,a4,b80 <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 b7c:	fee7eae3          	bltu	a5,a4,b70 <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
 b80:	ff852583          	lw	a1,-8(a0)
 b84:	6390                	ld	a2,0(a5)
 b86:	02059713          	slli	a4,a1,0x20
 b8a:	9301                	srli	a4,a4,0x20
 b8c:	0712                	slli	a4,a4,0x4
 b8e:	9736                	add	a4,a4,a3
 b90:	fae60ae3          	beq	a2,a4,b44 <free+0x14>
    bp->s.ptr = p->s.ptr;
 b94:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
 b98:	4790                	lw	a2,8(a5)
 b9a:	02061713          	slli	a4,a2,0x20
 b9e:	9301                	srli	a4,a4,0x20
 ba0:	0712                	slli	a4,a4,0x4
 ba2:	973e                	add	a4,a4,a5
 ba4:	fae689e3          	beq	a3,a4,b56 <free+0x26>
  } else
    p->s.ptr = bp;
 ba8:	e394                	sd	a3,0(a5)
  freep = p;
 baa:	00000717          	auipc	a4,0x0
 bae:	24f73723          	sd	a5,590(a4) # df8 <freep>
}
 bb2:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 be0:	21c53503          	ld	a0,540(a0) # df8 <freep>
 ...
 c08:	1f490913          	addi	s2,s2,500 # df8 <freep>
  if(p == (char*)-1)
 c0c:	5afd                	li	s5,-1
 c0e:	a88d                	j	c80 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 c10:	00004797          	auipc	a5,0x4
 c14:	1f078793          	addi	a5,a5,496 # 4e00 <base>
 c18:	00000717          	auipc	a4,0x0
 c1c:	1ef73023          	sd	a5,480(a4) # df8 <freep>
 c20:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 c26:	b7e1                	j	bee <malloc+0x36>
      if(p->s.size == nunits)
 c28:	02e48b63          	beq	s1,a4,c5e <malloc+0xa6>
        p->s.size -= nunits;
 ...
 c42:	1aa73d23          	sd	a0,442(a4) # df8 <freep>
      return (void*)(p + 1);
 ...
 c50:	7902                	ld	s2,32(sp)
 c52:	69e2                	ld	s3,24(sp)
 c54:	6a42                	ld	s4,16(sp)
 c56:	6aa2                	ld	s5,8(sp)
 c58:	6b02                	ld	s6,0(sp)
 c5a:	6121                	addi	sp,sp,64
 c5c:	8082                	ret
        prevp->s.ptr = p->s.ptr;
 c5e:	6398                	ld	a4,0(a5)
 c60:	e118                	sd	a4,0(a0)
 c62:	bff1                	j	c3e <malloc+0x86>
  hp->s.size = nu;
 c64:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
 c68:	0541                	addi	a0,a0,16
 c6a:	00000097          	auipc	ra,0x0
 c6e:	ec6080e7          	jalr	-314(ra) # b30 <free>
  return freep;
 c72:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
 c76:	d971                	beqz	a0,c4a <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 c78:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 c7a:	4798                	lw	a4,8(a5)
 c7c:	fa9776e3          	bgeu	a4,s1,c28 <malloc+0x70>
    if(p == freep)
 c80:	00093703          	ld	a4,0(s2)
 c84:	853e                	mv	a0,a5
 c86:	fef719e3          	bne	a4,a5,c78 <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
 c8a:	8552                	mv	a0,s4
 c8c:	00000097          	auipc	ra,0x0
 c90:	b46080e7          	jalr	-1210(ra) # 7d2 <sbrk>
  if(p == (char*)-1)
 c94:	fd5518e3          	bne	a0,s5,c64 <malloc+0xac>
        return 0;
 c98:	4501                	li	a0,0
 c9a:	bf45                	j	c4a <malloc+0x92>
