...
forktest(void)
{
  ...
  3e:	59e50513          	addi	a0,a0,1438 # 5d8 <malloc+0xe4>
  ...
  68:	58450513          	addi	a0,a0,1412 # 5e8 <malloc+0xf4>
  ...
  b8:	58450513          	addi	a0,a0,1412 # 638 <malloc+0x144>
  ...
  d4:	53850513          	addi	a0,a0,1336 # 608 <malloc+0x114>
  ...
  ee:	53650513          	addi	a0,a0,1334 # 620 <malloc+0x12c>
...
000000000000044c <rcu_read_only>:
...
0000000000000454 <rcu_read_heavy>:
...
000000000000045c <rcu_read_write_mix>:
...
0000000000000464 <rcu_read_stress>:
...
free(void *ap)
{
 ...
 470:	0800                	addi	s0,sp,16
  ...
  bp = (Header*)ap - 1;
 472:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 476:	00000797          	auipc	a5,0x0
 47a:	1d27b783          	ld	a5,466(a5) # 648 <freep>
 47e:	a805                	j	4ae <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
 480:	4618                	lw	a4,8(a2)
 482:	9db9                	addw	a1,a1,a4
 484:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
 488:	6398                	ld	a4,0(a5)
 48a:	6318                	ld	a4,0(a4)
 48c:	fee53823          	sd	a4,-16(a0)
 490:	a091                	j	4d4 <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
 492:	ff852703          	lw	a4,-8(a0)
 496:	9e39                	addw	a2,a2,a4
 498:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
 49a:	ff053703          	ld	a4,-16(a0)
 49e:	e398                	sd	a4,0(a5)
 4a0:	a099                	j	4e6 <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 4a2:	6398                	ld	a4,0(a5)
 4a4:	00e7e463          	bltu	a5,a4,4ac <free+0x40>
 4a8:	00e6ea63          	bltu	a3,a4,4bc <free+0x50>
{
 4ac:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 4ae:	fed7fae3          	bgeu	a5,a3,4a2 <free+0x36>
 4b2:	6398                	ld	a4,0(a5)
 4b4:	00e6e463          	bltu	a3,a4,4bc <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 4b8:	fee7eae3          	bltu	a5,a4,4ac <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
 4bc:	ff852583          	lw	a1,-8(a0)
 4c0:	6390                	ld	a2,0(a5)
 4c2:	02059713          	slli	a4,a1,0x20
 4c6:	9301                	srli	a4,a4,0x20
 4c8:	0712                	slli	a4,a4,0x4
 4ca:	9736                	add	a4,a4,a3
 4cc:	fae60ae3          	beq	a2,a4,480 <free+0x14>
    bp->s.ptr = p->s.ptr;
 4d0:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
 4d4:	4790                	lw	a2,8(a5)
 4d6:	02061713          	slli	a4,a2,0x20
 4da:	9301                	srli	a4,a4,0x20
 4dc:	0712                	slli	a4,a4,0x4
 4de:	973e                	add	a4,a4,a5
 4e0:	fae689e3          	beq	a3,a4,492 <free+0x26>
  } else
    p->s.ptr = bp;
 4e4:	e394                	sd	a3,0(a5)
  freep = p;
 4e6:	00000717          	auipc	a4,0x0
 4ea:	16f73123          	sd	a5,354(a4) # 648 <freep>
}
 4ee:	6422                	ld	s0,8(sp)
 4f0:	0141                	addi	sp,sp,16
 4f2:	8082                	ret

00000000000004f4 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
 ...
 508:	02051493          	slli	s1,a0,0x20
 50c:	9081                	srli	s1,s1,0x20
 50e:	04bd                	addi	s1,s1,15
 510:	8091                	srli	s1,s1,0x4
 512:	0014899b          	addiw	s3,s1,1
 516:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
 518:	00000517          	auipc	a0,0x0
 51c:	13053503          	ld	a0,304(a0) # 648 <freep>
 520:	c515                	beqz	a0,54c <malloc+0x58>
 ...
 522:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 524:	4798                	lw	a4,8(a5)
 526:	02977f63          	bgeu	a4,s1,564 <malloc+0x70>
 52a:	8a4e                	mv	s4,s3
 52c:	0009871b          	sext.w	a4,s3
 530:	6685                	lui	a3,0x1
 532:	00d77363          	bgeu	a4,a3,538 <malloc+0x44>
 536:	6a05                	lui	s4,0x1
 538:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
 53c:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
 ...
 544:	10890913          	addi	s2,s2,264 # 648 <freep>
  if(p == (char*)-1)
 548:	5afd                	li	s5,-1
 54a:	a88d                	j	5bc <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 54c:	00000797          	auipc	a5,0x0
 550:	10478793          	addi	a5,a5,260 # 650 <base>
 554:	00000717          	auipc	a4,0x0
 558:	0ef73a23          	sd	a5,244(a4) # 648 <freep>
 55c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 55e:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
 562:	b7e1                	j	52a <malloc+0x36>
      if(p->s.size == nunits)
 564:	02e48b63          	beq	s1,a4,59a <malloc+0xa6>
        p->s.size -= nunits;
 568:	4137073b          	subw	a4,a4,s3
 56c:	c798                	sw	a4,8(a5)
        p += p->s.size;
 ...
 574:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
 576:	0137a423          	sw	s3,8(a5)
      freep = prevp;
 57a:	00000717          	auipc	a4,0x0
 57e:	0ca73723          	sd	a0,206(a4) # 648 <freep>
      return (void*)(p + 1);
 582:	01078513          	addi	a0,a5,16
 ...
 59a:	6398                	ld	a4,0(a5)
 59c:	e118                	sd	a4,0(a0)
 59e:	bff1                	j	57a <malloc+0x86>
  hp->s.size = nu;
 5a0:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
 5a4:	0541                	addi	a0,a0,16
 5a6:	00000097          	auipc	ra,0x0
 5aa:	ec6080e7          	jalr	-314(ra) # 46c <free>
  return freep;
 5ae:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
 5b2:	d971                	beqz	a0,586 <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 5b4:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 5b6:	4798                	lw	a4,8(a5)
 5b8:	fa9776e3          	bgeu	a4,s1,564 <malloc+0x70>
    if(p == freep)
 5bc:	00093703          	ld	a4,0(s2)
 5c0:	853e                	mv	a0,a5
 5c2:	fef719e3          	bne	a4,a5,5b4 <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
 5c6:	8552                	mv	a0,s4
 5c8:	00000097          	auipc	ra,0x0
 5cc:	e54080e7          	jalr	-428(ra) # 41c <sbrk>
  if(p == (char*)-1)
 5d0:	fd5518e3          	bne	a0,s5,5a0 <malloc+0xac>
        return 0;
 5d4:	4501                	li	a0,0
 5d6:	bf45                	j	586 <malloc+0x92>
